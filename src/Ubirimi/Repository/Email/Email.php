...
class Email
{
    ...
    public function sendNewUserNotificationEmail(
        $clientId,
        $firstName,
        $lastName,
        $username,
    ...
    public function sendNewUserRepositoryNotificationEmail(
        $clientId,
        $firstName,
        $lastName,
        $username,
    ...
    public function sendUserChangedPasswordForRepositoryNotificationEmail(
        $clientId,
        $firstName,
        $lastName,
        $username,
    ...
    public function triggerAssignIssueNotification(
        $clientId,
        $issue,
        $oldUserAssignedName,
        $newUserAssignedName,
    ...
    )
    {
        ...
        while ($users && $user = $users->fetch_array(MYSQLI_ASSOC)) {
            ...
            UbirimiContainer::get()['repository']->get(Email::class)->sendEmailIssueAssign(
                $issue,
                $clientId,
                $oldUserAssignedName,
                $newUserAssignedName,
    ...
    private function sendEmailNewIssue($clientId, $issue, $userToNotify)
    {
        ...
        $versionsAffected = UbirimiContainer::get()['repository']->get(IssueVersion::class)->getByIssueIdAndProjectId(
            $issueId,
            $projectId,
            Issue::ISSUE_AFFECTED_VERSION_FLAG
        );
        $versionsFixed = UbirimiContainer::get()['repository']->get(IssueVersion::class)->getByIssueIdAndProjectId(
            $issueId,
            $projectId,
        ...
        $customFieldsSingleValue = UbirimiContainer::get()['repository']->get(CustomField::class)->getCustomFieldsData(
            $issueId
        );
        $customFieldsUserPickerMultiple = UbirimiContainer::get()['repository']->get(
            CustomField::class
        )->getUserPickerData($issueId);
    ...
    public function sendEmailIssueAssign(
        $issue,
        $clientId,
        $oldUserAssignedName,
        $newUserAssignedName,
    ...
    public function triggerIssueUpdatedNotification($clientId, $issue, $loggedInUserId, $changedFields)
    {
        ...
        while ($users && $user = $users->fetch_array(MYSQLI_ASSOC)) {
            ...
            UbirimiContainer::get()['repository']->get(Email::class)->sendEmailIssueChanged(
                $issue,
                $project,
                $loggedInUser,
                $clientId,
    ...
    public function sendEmailNotificationWorkLogged(
        $issue,
        $clientId,
        $project,
        $userToNotify,
    ...
    public function sendEmailNotificationAddAttachment(
        $issue,
        $clientId,
        $project,
        $userToNotify,
    ...
    public function sendEmailNotificationWorkLogUpdated(
        $issue,
        $clientId,
        $project,
        $userToNotify,
    ...
    public function sendEmailNotificationWorkLogDeleted(
        $issue,
        $clientId,
        $project,
        $userToNotify,
...
//        }
    ...
    private function sendEmailDeleteIssue($issue, $clientId, $user, $loggedInUser, $project)
    {
        ...
        if (Email::$smtpSettings) {
            ...
            UbirimiContainer::get()['repository']->get(EmailQueue::class)->add(
                ...
                Util::getTemplate(
                    '_deleteIssue.php',
                    array('issue' => $issue, 'loggedInUser' => $loggedInUser, 'project' => $project)
                ),
                Util::getServerCurrentDateTime()
            );
        }
    ...
    public function triggerDeleteIssueNotification($clientId, $issue, $project, $extraInformation)
    {
        ...
        while ($users && $user = $users->fetch_array(MYSQLI_ASSOC)) {
            ...
            UbirimiContainer::get()['repository']->get(Email::class)->sendEmailDeleteIssue(
                $issue,
                $clientId,
                $user,
                $loggedInUser,
