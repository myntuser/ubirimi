            ...
            <td>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-left">
                        <?php if (isset($tagId)): ?>
                            <li><a href="/quick-notes/tag/snippets/<?php echo $notebookId ?>/<?php echo $noteId ?>">Snippets</a>
                            </li>
                            <li><a href="/quick-notes/tag/list/<?php echo $notebookId ?>/<?php echo $noteId ?>">List</a>
                            </li>
                        <?php else: ?>
                            <?php if (-1 != $notebookId): ?>
                                <li>
                                    <a href="/quick-notes/note/snippets/<?php echo $notebookId ?>/<?php echo $noteId ?>">Snippets</a>
                                </li>
                                <li><a href="/quick-notes/note/list/<?php echo $notebookId ?>/<?php echo $noteId ?>">List</a>
                                </li>
                            <?php else: ?>
    ...
    <table id="contentNotesList" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td width="10%" valign="top"
                style="border-right: 1px solid #c6c6c6; border-top: 1px solid #DDDDDD; height: 33px;">
                        ...
                        <?php if ($notes): ?>
                            <table class="table table-hover table-condensed">
                                ...
                                <?php foreach ($notes as $currentNote): ?>
                                    <tr class="<?php if ($noteId == $currentNote['id']) {
                                        echo 'trSelected';
                                    } ?> noteListView" id="table_row_<?php echo $currentNote['id'] ?>">
                                        <td width="50%"><?php echo $currentNote['summary'] ?></td>
                                        <td width="30%">
                                            <?php
                                            $noteTags = UbirimiContainer::get()['repository']->get(
                                                Note::class
                                            )->getTags($currentNote['id']);
                                            if ($noteTags) {
