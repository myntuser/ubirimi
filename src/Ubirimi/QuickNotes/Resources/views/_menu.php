...
<table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#6A8EB2"
    ...
    <tr>
        <td>
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="center" class="menuItemBasic <?php if ($menuSelectedCategory == 'notebooks') {
                        echo 'menuItemSelected';
                    } else echo 'menuItem' ?>" id="menuNotebooks">
                        <span>Notebooks</span>
                        <span class="<?php if ($menuSelectedCategory == 'notebooks') {
                            echo 'arrowSelected';
                    ...
                    <td class="menuItemBasic <?php if ($menuSelectedCategory == 'notes') {
                        echo 'menuItemSelected';
                    } else echo 'menuItem' ?>" id="menuNotes">
                        <span><a style="<?php if ($menuSelectedCategory == 'notes') {
                                echo 'color: black';
                            } else echo 'color: white;' ?>" href="/quick-notes/note/snippets/all"
                                 class="linkNoUnderline">Notes</a></span>
                        &nbsp;
                    </td>
                    <td width="8px"></td>

                    <td class="menuItemBasic <?php if ($menuSelectedCategory == 'tags') {
                        echo 'menuItemSelected';
                    } else echo 'menuItem' ?>" id="menuTags">
                        <span><a style="<?php if ($menuSelectedCategory == 'tags') {
                                echo 'color: black';
                            } else echo 'color: white;' ?>" href="/quick-notes/tag/all" class="linkNoUnderline">Tags</a></span>
                        &nbsp;
                    </td>
                </tr>
            </table>
        ...
        <td align="right" style="vertical-align: middle">
            <input id="notebook_quick_search" type="text" style="height: 15px; font-style: italic;" value="Quick Search"
                   name="search"/>
        </td>
    </tr>
</table>
