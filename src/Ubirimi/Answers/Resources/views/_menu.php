...
<table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#6A8EB2" style="padding-left: 12px; padding-right: 12px;">
    <tr>
        <td>
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="center" class="menuItemBasic <?php if ($menuSelectedCategory == 'domains') echo 'menuItemSelected'; else echo 'menuItem' ?>" id="menuDomains">
                        <span>Domains</span>
                        <span class="<?php if ($menuSelectedCategory == 'domains') echo 'arrowSelected'; else echo 'arrow' ?>"></span>
                        &nbsp;
                    </td>
                </tr>
            </table>
        ...
        <td align="right" style="vertical-align: middle">
            <input type="button" id="btnCreateDomain" value="Create Domain" />
            <input id="answers_quick_search" type="text" style="height: 15px; font-style: italic;" value="Quick Search" name="search" />
        </td>
    </tr>
</table>
<div id="contentMenuDomains" style="display: none;">
    <table cellspacing="0" cellpadding="0" border="0" class="tableMenu" width="100%">
        <tr>
            <td>
                <div><a class="linkSubMenu" href="/answers/domains">All Domains</a></div>
            </td>
        </tr>
    </table>
</div>
...
<div class="ubirimiModalDialog" id="modalCreateDomain"></div>
