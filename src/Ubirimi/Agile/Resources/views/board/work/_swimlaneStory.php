...
$allSprintIssuesWithChildren = UbirimiContainer::get()['repository']->get(
    Sprint::class
)->getIssuesBySprintIdWithChildren($sprintId, null, $loggedInUserId);
...
$allSprintIssuesWithoutChildren = UbirimiContainer::get()['repository']->get(
    Sprint::class
)->getIssuesBySprintIdWithoutChildren($sprintId, null, $loggedInUserId, $parentChildrenIssueIds);
