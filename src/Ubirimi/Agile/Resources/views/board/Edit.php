...
<?php Util::renderBreadCrumb(
    '<a class="linkNoUnderline" href="/agile/boards">Agile Boards</a> > ' . $board['name'] . '> Update'
) ?>
    ...
    <form name="add_board" action="/agile/board/edit/<?php echo $boardId ?>" method="post">
        <table width="100%">
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="confirm_edit_board" class="btn ubirimi-btn"><i
                                class="icon-edit"></i> Update Board
                        </button>
