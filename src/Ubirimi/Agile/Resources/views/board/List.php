...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a id="btnNew" href="/agile/board/add" class="btn ubirimi-btn"><i class="icon-plus"></i> Create New
                    Board</a></td>
            <td><a id="btnEditBoard" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i> Edit</a></td>
            <td><a id="btnDeleteBoard" href="#" class="btn ubirimi-btn disabled"><i class="icon-remove"></i> Delete</a>
            </td>
        ...
        <table class="table table-hover table-condensed">
            ...
            <?php while ($board = $boards->fetch_array(MYSQLI_ASSOC)): ?>
                <tr id="table_row_<?php echo $board['id'] ?>">
                    ...
                    <td>
                        <div><a href="/agile/board/plan/<?php echo $board['id'] ?>"><?php echo $board['name'] ?></a>
                        </div>
                    </td>
                    <td>
                        ...
                        for ($i = 0; $i < count($definitionData); $i++) {
                            ...
                            if ($tempData[0] == 'project') {
                                ...
                                $projects = UbirimiContainer::get()['repository']->get(
                                    YongoProject::class
                                )->getByClientIdAndIds($clientId, $projectIds);
                                echo '<ul>';
