...
<div class="pageContent">
    <ul class="nav nav-tabs" style="padding: 0px; float: right;">
        ...
        <li class="active"><a
                href="/agile/board/report/<?php echo $sprintId ?>/<?php echo $boardId ?>/<?php echo $chart ?>"
                title="Report">Report</a></li>
    </ul>
        ...
        <tr>
            <td>
                <?php if (isset($selectedSprint)): ?>
                    <a id="report_agile_select_sprint" href="#"
                       class="btn ubirimi-btn"><?php echo $selectedSprint['name'] ?> <img border="0"
                                                                                          src="/img/br_down.png"
                                                                                          style="padding-bottom: 2px;"/></a>
                <?php else: ?>
                    <a id="report_agile_select_sprint" href="#" class="btn ubirimi-btn disabled">No Completed Sprint</a>
                <?php endif ?>
            </td>
            <td>
                <a id="report_agile_select_report" href="#"
                   class="btn ubirimi-btn"><?php echo $availableCharts[$chart] ?> <img border="0" src="/img/br_down.png"
                                                                                       style="padding-bottom: 2px;"/></a>
            </td>
        </tr>
    </table>
    ...
    <div id="submenu_completed_sprints"
         style="border: 1px solid #BBBBBB; z-index: 500; position: absolute; width: 200px; background-color: #ffffff; display: none; padding: 4px; box-shadow: 3px 3px 5px rgba(0, 0, 0, 0.5);">
                    ...
                    <tr>
                        <td>
                            <div><a class="linkSubMenu"
                                    href="/agile/board/report/<?php echo $completedSprint['id'] ?>/<?php echo $boardId ?>/sprint_report"><?php echo $completedSprint['name'] ?></a>
                            </div>
                        </td>
                    </tr>
                <?php endwhile ?>
    ...
    <div id="submenu_reports_available"
         style="border: 1px solid #BBBBBB; z-index: 500; position: absolute; width: 200px; background-color: #ffffff; display: none; padding: 4px; box-shadow: 3px 3px 5px rgba(0, 0, 0, 0.5);">
        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="tableMenu">
            <?php foreach ($availableCharts as $key => $name): ?>
                <?php if ($key != $chart): ?>
                    <tr>
                        <td>
                            <div><a class="linkSubMenu"
                                    href="/agile/board/report/<?php echo $sprintId ?>/<?php echo $boardId ?>/<?php echo $key ?>"><?php echo $name ?></a>
                            </div>
                        </td>
                    </tr>
                <?php endif ?>
