...
<table>
    ...
    <tr>
        ...
        <td>
            <input value="<?php echo $today ?>" type="text" class="inputText" id="sprint_start_date"
                   style="width: 100px"/>
    ...
    <tr>
        ...
        <td>
            <input value="<?php echo $todayPlus2Weeks ?>" type="text" class="inputText" id="sprint_end_date"
                   style="width: 100px"/>
