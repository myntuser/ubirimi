...
class DuplicateController extends UbirimiController
{
    public function indexAction(Request $request, SessionInterface $session)
    {
        ...
        $issueSystemFields = array(
            'reporter' => $oldIssueData[Field::FIELD_REPORTER_CODE],
            'summary' => $summary,
            'priority' => $oldIssueData['priority'],
            'assignee' => $oldIssueData['assignee'],
            'description' => $oldIssueData['description'],
            Field::FIELD_DUE_DATE_CODE => $oldIssueData['due_date'],
            'environment' => $oldIssueData['environment'],
            'type' => $oldIssueData['type']
        );

        $issueReturnValues = $this->getRepository(Issue::class)->add(
            $project,
            $currentDate,
            $issueSystemFields,
            $loggedInUserId
        ...
        $versions = $this->getRepository(IssueVersion::class)->getByIssueIdAndProjectId(
            $oldIssueData['id'],
            $oldIssueData['issue_project_id'],
        ...
        $targets = $this->getRepository(IssueVersion::class)->getByIssueIdAndProjectId(
            $oldIssueData['id'],
            $oldIssueData['issue_project_id'],
