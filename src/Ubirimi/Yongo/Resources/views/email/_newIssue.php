    ...
    <div style="background-color: #ffffff; border-radius: 5px; border: #CCCCCC 1px solid; padding: 10px; margin: 10px;">
        ...
        <table width="100%" border="0">
            <tr>
                <td style="width=" 80
                ">Project:</td>
                <td><a href="<?php echo $session->get(
                        'client/base_url'
                    ) ?>/yongo/project/<?php echo $this->issue['issue_project_id'] ?>"><?php echo $this->issue['project_name'] ?></a>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Reporter:</td>
                <td>
                    <a href="<?php echo $session->get(
                        'client/base_url'
                    ) ?>/yongo/user/profile/<?php echo $this->issue['reporter'] ?>"><?php echo $this->issue['ur_first_name'] . ' ' . $this->issue['ur_last_name'] ?></a>
                </td>
            </tr>
            <tr>
                <td>Assignee:</td>
                <td>
                    <?php if ($this->issue['ua_first_name']): ?>
                        <a href="<?php echo $session->get(
                            'client/base_url'
                        ) ?>/yongo/user/profile/<?php echo $this->issue['assignee'] ?>"><?php echo $this->issue['ua_first_name'] . ' ' . $this->issue['ua_last_name'] ?></a>
                    <?php else: ?>
                        Unassigned
                    <?php endif ?>
                </td>
