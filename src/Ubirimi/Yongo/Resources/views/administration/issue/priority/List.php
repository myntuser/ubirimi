...
<div class="pageContent">
    <?php if (Util::userHasYongoAdministrativePermission()): ?>
        ...
        <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
            <tr>
                <td><a id="btnNew" href="/yongo/administration/issue/priority/add" class="btn ubirimi-btn"><i
                            class="icon-plus"></i> Create Priority</a></td>
                <?php if ($priorities): ?>
                    <td><a id="btnEditIssuePriority" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i>
                            Edit</a></td>
                    <td><a id="btnDeleteIssuePriority" href="#" class="btn ubirimi-btn disabled"><i
            ...
            <table class="table table-hover table-condensed">
                ...
                <?php while ($priority = $priorities->fetch_array(MYSQLI_ASSOC)): ?>
                    <tr id="table_row_<?php echo $priority['id'] ?>">
                        ...
                        <td>
                            <div style="background-color:<?php echo $priority['color'] ?>; width: 20px; height: 20px;">
                                &nbsp;</div>
                        </td>
                    </tr>
                <?php endwhile ?>
