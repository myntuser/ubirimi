...
<?php Util::renderBreadCrumb(
    '<a class="linkNoUnderline" href="/yongo/administration/issue/priorities">Issue Priorities</a> > Edit Priority'
) ?>
    ...
    <form name="add_priority" action="/yongo/administration/issue/priority/edit/<?php echo $Id ?>" method="post">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea name="description"
                              class="inputTextAreaLarge"><?php echo $issuePriority['description'] ?></textarea>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input class="inputText color {hash:true}" style="width: 100px" name="color"
                           value="<?php echo $issuePriority['color'] ?>"/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="edit_priority" class="btn ubirimi-btn"><i class="icon-edit"></i>
                            Update priority
                        </button>
