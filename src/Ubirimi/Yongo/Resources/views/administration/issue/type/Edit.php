...
<?php Util::renderBreadCrumb(
    '<a class="linkNoUnderline" href="/yongo/administration/issue-types">Issue Types</a> > Edit Type'
) ?>
    ...
    <form name="edit_type" action="/yongo/administration/issue/edit-type/<?php echo $Id ?>" method="post">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea name="description"
                              class="inputTextAreaLarge"><?php echo $issueType['description'] ?></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td></td>
                <td align="left">
                    <button type="submit" name="edit_type" class="btn ubirimi-btn"><i class="icon-edit"></i> Update Type
                    </button>
