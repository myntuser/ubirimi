...
<div class="pageContent">
    <?php if (Util::userHasYongoAdministrativePermission()): ?>
        ...
        <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
            <tr>
                <td><a id="btnNew" href="/yongo/administration/issue/add-type" class="btn ubirimi-btn"><i
                            class="icon-plus"></i> Create Issue Type</a></td>
                <?php if ($types): ?>
                    <td><a id="btnEditIssueType" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i>
                            Edit</a></td>
                    <td><a id="btnDeleteIssueType" href="#" class="btn ubirimi-btn disabled"><i class="icon-remove"></i>
                            Delete</a></td>
                <?php endif ?>
            </tr>
        </table>
                    ...
                    <tr id="table_row_<?php echo $type['id'] ?>">
                        <td>
                            ...
                            <div class="smallDescription"
                                 style="padding-left: 25px"><?php echo $type['description'] ?></div>
                        </td>
                        <td width="500px">
                            <ul>
                                <?php
                                $schemes = UbirimiContainer::get()['repository']->get(
                                    IssueType::class
                                )->getSchemesForIssueTypeId($type['id'], 'project');
