...
<?php Util::renderBreadCrumb(
    '<a class="linkNoUnderline" href="/yongo/administration/issue/resolutions">Issue Resolutions</a> > Create Resolution'
) ?>
    ...
    <form name="add_priority" action="/yongo/administration/issue/resolution/add" method="post">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="new_resolution" class="btn ubirimi-btn"><i class="icon-plus"></i>
