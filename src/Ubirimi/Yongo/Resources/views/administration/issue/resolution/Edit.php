...
<?php Util::renderBreadCrumb(
    '<a class="linkNoUnderline" href="/yongo/administration/issue/resolutions">Issue Resolutions</a> > Edit Resolution'
) ?>
    ...
    <form name="add_resolution" action="/yongo/administration/issue/resolution/edit/<?php echo $Id ?>" method="post">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea class="inputTextAreaLarge"
                              name="description"><?php echo $issueResolution['description'] ?></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="edit_resolution" class="btn ubirimi-btn"><i class="icon-edit"></i>
                            Update Resolution
                        </button>
