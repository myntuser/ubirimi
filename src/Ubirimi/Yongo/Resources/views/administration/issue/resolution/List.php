...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a id="btnNew" href="/yongo/administration/issue/resolution/add" class="btn ubirimi-btn"><i
                        class="icon-plus"></i> Create Resolution</a></td>
            <?php if ($resolutions): ?>
                <td><a id="btnEditIssueResolution" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i>
                        Edit</a></td>
                <td><a id="btnDeleteIssueResolution" href="#" class="btn ubirimi-btn disabled"><i
