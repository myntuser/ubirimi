...
<div class="pageContent">
    <?php if (Util::userHasYongoAdministrativePermission()): ?>
        ...
        <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
            <tr>
                <td><a href="/yongo/administration/issue-security-scheme/add" class="btn ubirimi-btn"><i
                            class="icon-plus"></i> Create Issue Security Scheme</a></td>
                <td><a id="btnIssueSecurityLevels" href="#" class="btn ubirimi-btn disabled">Security Levels</a></td>
                <td><a id="btnEditIssueSecurityScheme" href="#" class="btn ubirimi-btn disabled"><i
                            class="icon-edit"></i> Edit</a></td>
                <td><a id="btnDeleteIssueSecurityScheme" href="#" class="btn ubirimi-btn disabled"><i
                            class="icon-remove"></i> Delete</a></td>
            </tr>
        </table>

        <div class="infoBox">
            Issue Security Schemes allow you to control who can and cannot view issues. They consist of a number of
            security levels which can have users/groups assigned to them.<br/>
            When creating/editing an issue you can specify a level of security for the issue. This ensures only users
            who are assigned to this security level may view the issue.<br/>
                    ...
                    <tr id="table_row_<?php echo $scheme['id'] ?>">
                        ...
                        <td>
                            ...
                            $projects = UbirimiContainer::get()['repository']->get(
                                YongoProject::class
                            )->getByIssueSecurityScheme($scheme['id']);
                            if ($projects) {
                                echo '<ul>';
