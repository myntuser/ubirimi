...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a href="/yongo/administration/issue-security-scheme/level/add/<?php echo $issueSecuritySchemeId ?>"
                   class="btn ubirimi-btn"><i class="icon-plus"></i> Create Level</a></td>
            <td><a id="btnEditIssueSecuritySchemeLevel" href="#" class="btn ubirimi-btn disabled"><i
                        class="icon-edit"></i> Edit</a></td>
            <td><a id="btnDeleteIssueSecuritySchemeLevel" href="#" class="btn ubirimi-btn disabled"><i
                        class="icon-remove"></i> Delete</a></td>
        </tr>
    </table>

    <div class="infoBox">
        On this page you can create and delete the issue security levels for the
        "<?php echo $issueSecurityScheme['name'] ?>" issue security scheme.<br/>
        Each security level can have users/groups assigned to them.<br/>
        An issue can then be assigned a Security Level. This ensures only users who are assigned to this security level
        may view the issue.
    </div>
        ...
        <table class="table table-hover table-condensed">
            ...
            <?php while ($level = $issueSecuritySchemeLevels->fetch_array(MYSQLI_ASSOC)): ?>
                <tr id="table_row_<?php echo $level['id'] ?>">
                    ...
                    <td>
                        <?php
                        $securitySchemeData = UbirimiContainer::get()['repository']->get(
