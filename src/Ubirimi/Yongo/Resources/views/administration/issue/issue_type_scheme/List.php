...
<div class="pageContent">
    <?php if (Util::userHasYongoAdministrativePermission()): ?>
        ...
        <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
            <tr>
                <td><a id="btnNew" href="/yongo/administration/issue/add-type-scheme/project" class="btn ubirimi-btn"><i
                            class="icon-plus"></i> Create Issue Type Scheme</a></td>
                ...
                <td><a id="btnDeleteIssueTypeScheme" href="#" class="btn ubirimi-btn disabled"><i
                            class="icon-remove"></i> Delete</a></td>
            </tr>
        </table>
        <div class="infoBox">An issue type scheme determines which issue types will be available to a set of projects.
            It also allows to specify the order in which the issue types are presented in the user interface.
        </div>
                    ...
                    <tr id="table_row_<?php echo $scheme['id'] ?>">
                        <td>
                            ...
                            <div class="smallDescription"
                                 style="padding-left: 25px;"><?php echo $scheme['description'] ?></div>
                        </td>
                        <td>
                            <?php
                            $dataIssueTypeScheme = UbirimiContainer::get()['repository']->get(
                        ...
                        <td>
                            ...
                            $projects = UbirimiContainer::get()['repository']->get(
                                YongoProject::class
                            )->getByIssueTypeScheme($scheme['id']);
                            if ($projects) {
