...
<div class="pageContent">
    <form name="add_status" action="/yongo/administration/issue/edit-type-scheme/<?php echo $issueTypeSchemeId ?>"
          method="post">
        ...
        <table width="100%">
            ...
            <tr>
                <td></td>
                <td align="left">
                    <button type="submit" name="edit_type_scheme" class="btn ubirimi-btn"><i class="icon-edit"></i>
                        Update Scheme
                    </button>
