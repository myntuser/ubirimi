...
<div class="pageContent">
    <?php Util::renderBreadCrumb(
        '<a class="linkNoUnderline" href="/yongo/administration/issue-features/linking">Issue Linking</a> > Create Link Type'
    ) ?>
    <form name="add_link_type" action="/yongo/administration/link-type/add" method="post">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <input class="inputText" type="text" value="<?php if (isset($outwardDescription)) {
                        echo $outwardDescription;
                    } ?>" name="outward"/>
            ...
            <tr>
                ...
                <td>
                    <input class="inputText" type="text" value="<?php if (isset($inwardDescription)) {
                        echo $inwardDescription;
                    } ?>" name="inward"/>
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="new_link_type" class="btn ubirimi-btn"><i class="icon-plus"></i>
                            Create Link Type
                        </button>
