    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <?php if ($issueLinkingFlag): ?>
                <td><a id="btnNew" href="/yongo/administration/link-type/add" class="btn ubirimi-btn"><i
                            class="icon-plus"></i> Create Link Type</a></td>
                <td><a id="btnEditLinkType" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i> Edit</a>
                </td>
                <td><a id="btnDeleteLinkType" href="#" class="btn ubirimi-btn disabled"><i class="icon-remove"></i>
                        Delete</a></td>
            <?php endif ?>
            <td><a href="/yongo/administration/toggle-issue-linking"
                   class="btn ubirimi-btn"><?php if ($issueLinkingFlag) {
                        echo 'Deactivate';
