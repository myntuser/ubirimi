        ...
        <tr>
            <td>
                <div class="headerPageText">
                    <a class="linkNoUnderline" href="/yongo/administration/issue-features/linking">Issue Linking</a>
                    > <?php echo $linkType['name'] ?> > Update Link Type
                </div>
            </td>
        </tr>
    </table>
    ...
    <form name="edit_link_type" action="/yongo/administration/link-type/edit/<?php echo $linkTypeId ?>" method="post">
        <table width="100%">
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="edit_link_type" class="btn ubirimi-btn"><i class="icon-edit"></i>
                            Update Link Type
                        </button>
