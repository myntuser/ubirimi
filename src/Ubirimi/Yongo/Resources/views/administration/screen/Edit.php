        ...
        <tr>
            <td>
                <div class="headerPageText">
                    <a class="linkNoUnderline" href="/yongo/administration/screens">Screens</a>
                    > <?php echo $screen['name'] ?> > Update
                </div>
            </td>
        </tr>
    </table>
    ...
    <form name="edit_screen_metadata" action="/yongo/administration/screen/edit/<?php echo $screenId ?>" method="post">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea class="inputTextAreaLarge"
                              name="description"><?php echo $screen['description'] ?></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="edit_workflow_screen" class="btn ubirimi-btn"><i
                                class="icon-edit"></i> Update Screen
                        </button>
