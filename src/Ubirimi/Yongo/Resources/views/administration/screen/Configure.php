    ...
    <form name="add_priority" action="/yongo/administration/screen/configure/<?php echo $screenId ?>" method="post">
        ...
        <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
            <tr>
                <td align="left">
                    <?php if ($source == 'project_screen'): ?>
                        <a class="btn ubirimi-btn"
                           href="/yongo/administration/project/screens/<?php echo $projectId ?>">Go Back</a>
                    <?php elseif ($source == 'project_field'): ?>
                        <a class="btn ubirimi-btn" href="/yongo/administration/project/fields/<?php echo $projectId ?>">Go
                            Back</a>
                    <?php else: ?>
                ...
                <td>
                    <a id="btnDeleteScreenField" href="#" class="btn ubirimi-btn disabled"><i class="icon-remove"></i>
                        Delete</a>
                </td>
            </tr>
        </table>
                ...
                <table class="table table-hover table-condensed">
                    ...
                    <?php while ($data = $screenData->fetch_array(MYSQLI_ASSOC)): ?>
                        ...
                        <tr id="table_row_<?php echo $data['id'] ?>">
                            <td width="22"><input type="checkbox" value="1" id="el_check_<?php echo $data['id'] ?>"/>
                            </td>
                            ...
                            <td width="20" align="left">
                                <?php if ($index != 1): ?>
                                    <a href="/yongo/administration/screen/configure/<?php echo $screenId ?>?position=<?php echo($index - 1) ?>&field_id=<?php echo $data['field_id'] ?>"><img
                                            src="/img/arrow_up_blue.gif"/></a>
                                <?php endif ?>
                            </td>
