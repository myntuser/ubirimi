...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            ...
            <td><a id="btnEditScreenSchemeData" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i> Edit</a>
            </td>
        </tr>
    </table>
        ...
        <table class="table table-hover table-condensed">
            ...
            <?php while ($data = $screenSchemeData->fetch_array(MYSQLI_ASSOC)): ?>
                <tr id="table_row_<?php echo $data['id'] ?>">
                    ...
                    <td>
                        <a href="/yongo/administration/screen/configure/<?php echo $data['screen_id'] ?>"><?php echo $data['screen_name']; ?></a>
                    </td>
                </tr>
            <?php endwhile ?>
            </tbody>
