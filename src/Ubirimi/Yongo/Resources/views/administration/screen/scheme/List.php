...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a id="btnNew" href="/yongo/administration/screen/add-scheme" class="btn ubirimi-btn"><i
                        class="icon-plus"></i> Create Screen Scheme</a></td>
            <td><a id="btnEditScreenSchemeMetadata" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i>
                    Edit</a></td>
            <td><a id="btnConfigureScreenScheme" href="#" class="btn ubirimi-btn disabled"><i class="icon-wrench"></i>
                    Configure</a></td>
            <td><a id="btnCopyScreenScheme" href="#" class="btn ubirimi-btn disabled">Copy</a></td>
            <td><a id="btnDeleteScreenScheme" href="#" class="btn ubirimi-btn"><i class="icon-remove"></i> Delete</a>
            </td>
        </tr>
    </table>
    <div class="infoBox">Screen Schemes allow you to choose what screens are shown for each issue operation. Screen
        Schemes are mapped to issue types using <a href="/yongo/administration/screens/issue-types">Issue Type Screen
            Schemes</a>, which can be associated with one or more projects.
    </div>
        ...
        <table class="table table-hover table-condensed">
            ...
            <?php while ($scheme = $screensSchemes->fetch_array(MYSQLI_ASSOC)): ?>
                <tr id="table_row_<?php echo $scheme['id'] ?>">
                    ...
                    <td width="500px">
                        <?php
                        $issueTypeScreenSchemes = UbirimiContainer::get()['repository']->get(
                            IssueTypeScreenScheme::class
                        )->getByScreenSchemeId($scheme['id']);
