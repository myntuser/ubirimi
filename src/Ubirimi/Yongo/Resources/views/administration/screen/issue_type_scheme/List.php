...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a id="btnNew" href="/yongo/administration/screen/add-scheme-issue-type" class="btn ubirimi-btn"><i
                        class="icon-plus"></i> Create Issue Type Screen Scheme</a></td>
            <td><a id="btnEditIssueTypeScreenScheme" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i>
                    Edit</a></td>
            <td><a id="btnConfigureIssueTypeScreenScheme" href="#" class="btn ubirimi-btn disabled"><i
                        class="icon-wrench"></i> Configure</a></td>
            <td><a id="btnCopyIssueTypeScreenScheme" href="#" class="btn ubirimi-btn disabled">Copy</a></td>
            <td><a id="btnDeleteIssueTypeScreenScheme" href="#" class="btn ubirimi-btn disabled"><i
                        class="icon-remove"></i> Delete</a></td>
        </tr>
    </table>
    <div class="infoBox">
        <div>An Issue Type Screen Scheme allows you to choose what <a href="/yongo/administration/screens/schemes">Screen
                Scheme</a> is used for each issue type.
        </div>
        <div>Then, an Issue Type Screen Scheme can be associated with one or more projects, to specify what Screen
            Scheme, and hence what <a href="/yongo/administration/screens">Screen</a> should be used for a particular
            issue operation for the projects' issues.
        </div>
    </div>
        ...
        <table class="table table-hover table-condensed">
            ...
            <?php while ($scheme = $issueTypeScreenSchemes->fetch_array(MYSQLI_ASSOC)): ?>
                <tr id="table_row_<?php echo $scheme['id'] ?>">
                    ...
                    <td width="500px">
                        <?php
                        $projects = UbirimiContainer::get()['repository']->get(
                            YongoProject::class
                        )->getByIssueTypeScreenSchemeId($clientId, $scheme['id']);
                        if ($projects) {
                            echo '<ul>';
