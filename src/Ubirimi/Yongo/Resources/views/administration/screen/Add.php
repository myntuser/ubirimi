...
<?php Util::renderBreadCrumb(
    '<a href="/yongo/administration/screens" class="linkNoUnderline">Screens</a> > Create Screen'
) ?>
    ...
    <form name="add_screen" action="/yongo/administration/screen/add" method="post">
        ...
        <table width="100%">
            ...
            <?php while ($field = $fields->fetch_array(MYSQLI_ASSOC)): ?>
                <tr>
                    <td colspan="2">
                        <input type="checkbox" value="1" name="field_<?php echo $field['id'] ?>"
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="add_screen" class="btn ubirimi-btn"><i class="icon-plus"></i> Create
                            Screen
                        </button>
