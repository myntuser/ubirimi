    ...
    <form name="edit_perm_role" action="/yongo/administration/role/edit/<?php echo $permissionRoleId ?>" method="post">
            ...
            <tr>
                <td>
                    <div class="headerPageText">
                        <a class="linkNoUnderline" href="/yongo/administration/roles">Roles</a>
                        > <?php echo $perm_role['name'] ?> > Edit Permission role
                    </div>
                </td>
            </tr>
        </table>
        <table width="100%">
            <tr>
                ...
                <td>
                    <input type="text" value="<?php if ($perm_role && $perm_role['name']) {
                        echo $perm_role['name'];
            ...
            <tr>
                ...
                <td>
                    <textarea class="inputTextAreaLarge"
                              name="description"><?php if ($perm_role && $perm_role['description']) {
                            echo $perm_role['description'];
                        } ?></textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="confirm_edit_perm_role" class="btn ubirimi-btn"><i
                                class="icon-edit"></i> Update Role
                        </button>
