<div class="infoBox">NOTE: When a new project is created, it will be assigned these 'default members' for the
    'Administrators' project role.
    <br/>Note that 'default members' apply only when a project is created.
    <br/>Changing the 'default members' for a project role will not affect role membership for existing projects.
</div>
...
<table align="center">
    ...
    <tr>
        ...
        <td align="center" style="vertical-align: middle">
            <a id="assign_user_btn" href="#" class="btn ubirimi-btn">&nbsp;<img border="0" height="10"
                                                                                src="/img/br_next.png" alt=""/>&nbsp;
            </a>

            <div></div>
            <a id="remove_user_btn" href="#" class="btn ubirimi-btn">&nbsp;<img border="0" height="10"
