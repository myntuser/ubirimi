...
<div class="pageContent">
    ...
    <?php if (Util::userHasYongoAdministrativePermission()): ?>
        ...
        <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
            <tr>
                <td><a id="btnNewPermRole" href="/yongo/administration/role/add" class="btn ubirimi-btn"><i
                            class="icon-plus"></i> Create Role</a></td>
                <td><a id="btnEditPermRole" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i> Edit</a>
                </td>
                ...
                <td><a id="btnDeletePermRole" href="#" class="btn ubirimi-btn disabled"><i class="icon-remove"></i>
                        Delete</a></td>
            </tr>
        </table>

        <?php $roles = UbirimiContainer::get()['repository']->get(Role::class)->getByClient(
