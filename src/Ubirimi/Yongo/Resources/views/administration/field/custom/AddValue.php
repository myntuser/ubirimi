...
<div class="pageContent">
    <?php if (Util::userHasDocumentadorAdministrativePermission()): ?>
        <form name="add_user_group" action="/yongo/administration/custom-field/value/add/<?php echo $customFieldId ?>"
              method="post">
            ...
            <table width="100%">
                <tr>
                    ...
                    <td>
                        <input class="inputText" type="text" value="<?php if (isset($value)) echo $value ?>"
                               name="value"/>
                        <?php if ($emptyValue): ?>
                            <br/>
                ...
                <tr>
                    <td></td>
                    <td>
                        <button type="submit" name="new_custom_value" class="btn ubirimi-btn"><i class="icon-plus"></i>
                            Create Custom Value
                        </button>
