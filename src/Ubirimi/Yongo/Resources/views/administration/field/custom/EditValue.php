...
<div class="pageContent">
    <?php if (Util::userHasDocumentadorAdministrativePermission()): ?>
        <form name="form_update_custom_field_value"
              action="/yongo/administration/custom-field/value/edit/<?php echo $valueId ?>" method="post">
            ...
            <table width="100%">
                <tr>
                    ...
                    <td>
                        <input class="inputText" type="text"
                               value="<?php if (isset($fieldValue['value'])) echo $fieldValue['value'] ?>"
                               name="value"/>
                        <?php if ($emptyValue): ?>
                            <br/>
                ...
                <tr>
                    <td></td>
                    <td>
                        <button type="submit" name="edit_custom_field_value" class="btn ubirimi-btn"><i
                                class="icon-plus"></i> Update Custom Value
                        </button>
                        <a class="btn ubirimi-btn"
                           href="/yongo/administration/custom-fields/define/<?php echo $customFieldId ?>">Cancel</a>
                    </td>
                </tr>
            </table>
        </form>
