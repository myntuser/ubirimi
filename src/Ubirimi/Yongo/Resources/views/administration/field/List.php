...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a id="btnNew" href="/yongo/administration/custom-field/add" class="btn ubirimi-btn"><i
                        class="icon-plus"></i> Create Custom Field</a></td>
            <?php if ($fields): ?>
                <td><a id="btnEditCustomField" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i> Edit</a>
                </td>
                <td><a id="btnCustomFieldPlaceOnScreens" href="#" class="btn ubirimi-btn disabled">Place on Screens</a>
                </td>
                <td><a id="btnDeleteCustomField" href="#" class="btn ubirimi-btn disabled"><i class="icon-remove"></i>
                        Delete</a></td>
            <?php endif ?>
        </tr>
    </table>
            ...
            <?php while ($field = $fields->fetch_array(MYSQLI_ASSOC)): ?>
                <tr id="table_row_<?php echo $field['id'] ?>">
                    ...
                    <td>
                        ...
                        <?php else: ?>
                            <?php $issueTypes = UbirimiContainer::get()['repository']->get(
                                Field::class
                            )->getIssueTypesFor($field['id']) ?>
                        ...
                        <?php else: ?>
                            <?php $projects = UbirimiContainer::get()['repository']->get(Field::class)->getProjectsFor(
                                $field['id']
                            ) ?>
