...
<div class="pageContent">
    ...
    <ul class="nav nav-tabs" style="padding: 0px;">
        ...
        <li class="active"><a href="/yongo/administration/field-configurations/schemes">Field Configuration Schemes</a>
        </li>
    </ul>

    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a id="btnNew" href="/yongo/administration/field-configuration/add-scheme" class="btn ubirimi-btn"><i
                        class="icon-plus"></i> Create Field Configuration Scheme</a></td>
            <?php if ($fieldConfigurationSchemes): ?>
                <td><a id="btnEditFieldConfigurationSchemeMetadata" href="#" class="btn ubirimi-btn disabled"><i
                            class="icon-edit"></i> Edit</a></td>
                <td><a id="btnEditFieldConfigurationScheme" href="#" class="btn ubirimi-btn disabled"><i
                            class="icon-wrench"></i> Configure</a></td>
                <td><a id="btnCopyFieldConfigurationScheme" href="#" class="btn ubirimi-btn disabled">Copy</a></td>
                <td><a id="btnDeleteFieldConfigurationScheme" href="#" class="btn ubirimi-btn disabled"><i
                            class="icon-remove"></i> Delete</a></td>
            <?php endif ?>
        </tr>
    </table>
    <div class="infoBox">
        Field Configuration Schemes map <a href="/yongo/administration/field-configurations">Field Configurations</a> to
        issue types. A Field Configuration Scheme can be associated with one or more projects, making issues in these
        projects use the Field Configuration mapped to their issue type.
    </div>
    <?php if ($fieldConfigurationSchemes): ?>
        <table class="table table-hover table-condensed">
            ...
            <?php while ($fieldConfigurationScheme = $fieldConfigurationSchemes->fetch_array(MYSQLI_ASSOC)): ?>
                <tr id="table_row_<?php echo $fieldConfigurationScheme['id'] ?>">
                    ...
                    <td width="500px">
                        <?php $projects = UbirimiContainer::get()['repository']->get(
                            YongoProject::class
                        )->getByIssueTypeFieldConfigurationScheme($clientId, $fieldConfigurationScheme['id']) ?>
                        <?php if ($projects): ?>
                            <ul>
                            ...
                            <input type="hidden" id="delete_possible_<?php echo $fieldConfigurationScheme['id'] ?>"
                                   value="0"/>
                        <?php else: ?>
                            <input type="hidden" id="delete_possible_<?php echo $fieldConfigurationScheme['id'] ?>"
                                   value="1"/>
