...
<?php Util::renderBreadCrumb(
    '<a class="linkNoUnderline" href="/yongo/administration/custom-fields">Custom Fields</a> > Create Custom Field - Details (Step 2 of 2)'
) ?>
<div class="pageContent">
    <form name="add_custom_field" action="/yongo/administration/custom-field/add-data/<?php echo $fieldTypeCode ?>"
          method="post">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="finish_custom_field" class="btn ubirimi-btn"><i
                                class="icon-plus"></i> Create Custom Field
                        </button>
