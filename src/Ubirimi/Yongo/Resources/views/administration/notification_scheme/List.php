...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a id="btnNew" href="/yongo/administration/notification-scheme/add" class="btn ubirimi-btn"><i
                        class="icon-plus"></i> Create Notification Scheme</a></td>
            <td><a id="btnNotifications" href="#" class="btn ubirimi-btn disabled">Notifications</a></td>
            <td><a id="btnEditNotificationScheme" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i>
                    Edit</a></td>
            <td><a id="btnCopyNotificationScheme" href="#" class="btn ubirimi-btn disabled">Copy</a></td>
            <td><a id="btnDeleteNotificationScheme" href="#" class="btn ubirimi-btn disabled"><i
                ...
                <tr id="table_row_<?php echo $scheme['id'] ?>">
                    ...
                    <td width="500px">
                        ...
                        $projects = UbirimiContainer::get()['repository']->get(
                            YongoProject::class
                        )->getByNotificationScheme($scheme['id']);
                        if ($projects) {
                            echo '<ul>';
