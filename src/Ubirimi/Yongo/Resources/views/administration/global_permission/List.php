...
<div class="pageContent">
    <?php if (Util::userHasYongoAdministrativePermission()): ?>
        ...
        <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
            <tr>
                <td><a href="/yongo/administration/global-permission/add" class="btn ubirimi-btn"><i
                            class="icon-plus"></i> Add Permission</a></td>
            </tr>
        </table>

        <div class="infoBox">These permissions apply to all projects. They are independent of project specific
            permissions. If you wish to set permissions on a project-by-project basis you can set them up in the <a
                href="/yongo/administration/permission-schemes">Permission Schemes</a>.
        </div>
            ...
            <?php while ($globalPermission = $globalPermissions->fetch_array(MYSQLI_ASSOC)): ?>
                <tr>
                    ...
                    <td>
                        ...
                        )->getDataByPermissionId($clientId, $globalPermission['id']);
                        if ($groups) {
                            echo '<ul>';
