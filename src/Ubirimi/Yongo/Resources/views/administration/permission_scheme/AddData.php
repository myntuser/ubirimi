        ...
        <tr>
            <td>
                <div class="headerPageText">
                    <a class="linkNoUnderline" href="/yongo/administration/permission-schemes">Permission Schemes</a> >
                    <a class="linkNoUnderline"
                       href="/yongo/administration/permission-scheme/edit/<?php echo $permissionSchemeId ?>"><?php echo $permissionScheme['name'] ?></a>
                    > Create Permission
                </div>
            </td>
            <td align="right">
                <div align="right">
                    <?php if (isset($backLink)): ?>
                        <a class="btn ubirimi-btn"
                           href="/yongo/administration/project/permissions/<?php echo $projectId ?>">Back</a>
                    <?php else: ?>
...
<div class="pageContent">
    ...
    <form name="add_permission_data"
          action="/yongo/administration/permission-scheme/add-data/<?php echo $permissionSchemeId ?>" method="post">
        <table width="100%">
            <tr>
                ...
                <td width="200">
                    <select class="inputTextCombo" name="permission[]" size="10" multiple="multiple">
                        <?php while ($permission = $permissions->fetch_array(MYSQLI_ASSOC)): ?>
                            <option <?php if ($permission['id'] == $permissionId) echo 'selected="selected"' ?>
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        ...
                        <a class="btn ubirimi-btn"
                           href="/yongo/administration/permission-scheme/edit/<?php echo $permissionSchemeId ?>">Cancel</a>
                    </div>
                </td>
                <td></td>
            </tr>
