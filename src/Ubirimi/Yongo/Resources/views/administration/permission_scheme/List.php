...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a id="btnNew" href="/yongo/administration/permission-scheme/add" class="btn ubirimi-btn"><i
                        class="icon-plus"></i> Create Permission Scheme</a></td>
            <td><a id="btnPermissions" href="#" class="btn ubirimi-btn disabled">Permissions</a></td>
            <td><a id="btnEditPermissionScheme" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i> Edit</a>
            </td>
            <td><a id="btnCopyPermissionScheme" href="#" class="btn ubirimi-btn disabled">Copy</a></td>
            <td><a id="btnDeletePermissionScheme" href="#" class="btn ubirimi-btn disabled"><i class="icon-remove"></i>
                    Delete</a></td>
        </tr>
    </table>
                ...
                <tr id="table_row_<?php echo $scheme['id'] ?>">
                    ...
                    <td width="500px">
                        ...
                        $projects = UbirimiContainer::get()['repository']->get(
                            YongoProject::class
                        )->getByPermissionScheme($scheme['id']);
                        if ($projects) {
                            echo '<ul>';
