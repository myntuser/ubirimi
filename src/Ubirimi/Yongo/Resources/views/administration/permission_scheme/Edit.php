        ...
        <tr>
            <td>
                <div class="headerPageText">
                    ...
                    > <?php echo $permissionScheme['name'] ?> > Edit
                </div>
            </td>
        </tr>
    </table>
            ...
            <td>
                <?php if (isset($backLink)): ?>
                    <a class="btn ubirimi-btn"
                       href="/yongo/administration/project/permissions/<?php echo $projectId ?>">Go Back</a>
                <?php else: ?>
                    ...
                    <td>
                        ...
                        if ($permData) {
                            ...
                            while ($data = $permData->fetch_array(MYSQLI_ASSOC)) {
                                ...
                                if ($data['user_id']) {
                                    echo '<li>Single User (' . LinkHelper::getUserProfileLink(
                                            $data['user_id'],
                                            SystemProduct::SYS_PRODUCT_YONGO,
                                            $data['first_name'],
                                            $data['last_name']
                                        ) . ') (<a href="#" id="perm_delete_' . $data['id'] . '">Delete</a>)</li>';
                                }
