...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a href="/yongo/administration/edit-attachment-configuration" class="btn ubirimi-btn"><i
                        class="icon-edit"></i> Edit Settings</a></td>
        </tr>
    </table>
    <table class="table table-hover table-condensed">
        ...
        <tr>
            ...
            <td><?php if ($settings['allow_attachments_flag']) {
                    echo 'Yes';
                } else echo 'No' ?></td>
        </tr>
        </tbody>
