    ...
    <form name="edit_attachments" method="post" action="/yongo/administration/edit-attachment-configuration">
        <table width="100%" style="border-spacing: 0">
            <tr>
                ...
                <td width="10"></td>
                <td>
                    <input <?php if ($settings['allow_attachments_flag']) echo 'checked="checked"' ?> type="radio"
                                                                                                      name="allow_attachments_flag"
                                                                                                      id="allow_attachments_ON"
                                                                                                      value="1">
                    <label for="allow_attachments_ON">ON</label>
                    <input <?php if (!$settings['allow_attachments_flag']) echo 'checked="checked"' ?> type="radio"
                                                                                                       name="allow_attachments_flag"
                                                                                                       id="allow_attachments_OFF"
                                                                                                       value="0">
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="update_configuration" class="btn ubirimi-btn"><i
                                class="icon-edit"></i> Update Settings
                        </button>
