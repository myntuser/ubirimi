        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td><textarea class="inputTextAreaLarge"
                              name="description"><?php if (isset($description)) echo $description ?></textarea></td>
            </tr>
            <tr>
                <td colspan="2">
                    <hr size="1"/>
            ...
            <tr>
                <td></td>
                <td>
                    <button type="submit" name="new_group" class="btn ubirimi-btn"><i class="icon-plus"></i> Create
                        Group
                    </button>
