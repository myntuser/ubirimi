...
<div class="pageContent">
    <?php if (Util::userHasYongoAdministrativePermission()): ?>
        ...
        <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
            <tr>
                <td><a id="btnNew" href="/yongo/administration/group/add" class="btn ubirimi-btn"><i
                            class="icon-plus"></i> Create Group</a></td>
                <td><a id="btnEditUserGroup" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i>
                        Edit</a></td>
                <td><a id="btnDeleteUserGroup" href="#" class="btn ubirimi-btn disabled"><i class="icon-remove"></i>
                        Delete</a></td>
