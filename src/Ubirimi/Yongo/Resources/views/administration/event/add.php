...
<?php Util::renderBreadCrumb(
    '<a class="linkNoUnderline" href="/yongo/administration/events">Events</a> > Create Event'
) ?>
    ...
    <form name="add_event" action="/yongo/administration/add-event" method="post">
        ...
        <table width="100%">
            ...
            <tr>
                <td></td>
                <td align="left">
                    <button type="submit" name="new_event" class="btn ubirimi-btn"><i class="icon-plus"></i> Create
                        Event
                    </button>
