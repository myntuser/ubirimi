    ...
    <form name="edit_configuration" method="post" action="/yongo/administration/general-configuration/edit">
        <table width="100%" cellspacing="0">
            ...
            <tr>
                ...
                <td width="10"></td>
                <td>
                    <input <?php if ($clientSettings['allow_unassigned_issues_flag']) echo 'checked="checked"' ?>
                        type="radio" name="allow_unassigned_issues" id="allow_unassigned_issues_ON" value="1">
                    <label for="allow_unassigned_issues_ON">ON</label>
                    <input <?php if (!$clientSettings['allow_unassigned_issues_flag']) echo 'checked="checked"' ?>
                        type="radio" name="allow_unassigned_issues" id="allow_unassigned_issues_OFF" value="0">
