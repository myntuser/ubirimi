        ...
        <tr>
            <td>
                <div class="headerPageText">
                    <a class="linkNoUnderline" href="/yongo/administration/workflows/schemes" ?>Workflow Schemes</a>
                    > <?php echo $workflowScheme['name'] ?> > Edit
                </div>
            </td>
        </tr>
    </table>
    ...
    <form name="add_status" action="/yongo/administration/workflows/edit-scheme/<?php echo $Id ?>" method="post">
            ...
            <?php while ($workflow = $allWorkflows->fetch_array(MYSQLI_ASSOC)): ?>
                <tr>
                    <td>
                        ...
                        ?>
                        <input <?php if ($found) echo 'checked="checked"' ?> type="checkbox" value="1"
                                                                             name="workflow_<?php echo $workflow['id'] ?>"/>
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="edit_workflow_scheme" class="btn ubirimi-btn"><i
                                class="icon-edit"></i> Update scheme
                        </button>
