...
<div class="pageContent">
    <form name="copy_workflow_scheme"
          action="/yongo/administration/workflows/scheme/copy/<?php echo $workflowSchemeId ?>" method="post">
        <?php
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea class="inputTextAreaLarge"
                              name="description"><?php echo $workflowScheme['description'] ?></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td align="let">
                    <div align="left">
                        <button type="submit" name="copy_workflow_scheme" class="btn ubirimi-btn">Copy Workflow Scheme
                        </button>
