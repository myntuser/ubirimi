...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a id="btnNew" href="/yongo/administration/workflows/add-scheme" class="btn ubirimi-btn"><i
                        class="icon-plus"></i> Create Workflow Scheme</a></td>
            <td><a id="btnEditWorkflowScheme" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i>
                    Edit</a></td>
            <td><a id="btnCopyWorkflowScheme" href="#" class="btn ubirimi-btn disabled">Copy</a></td>
            <td><a id="btnDeleteWorkflowScheme" href="#" class="btn ubirimi-btn"><i class="icon-remove"></i> Delete</a>
            </td>
        </tr>
    </table>
    <div class="infoBox">
        <div>Workflow Schemes allow you to put together a collection of workflows that is going to be used in a
            project.
        </div>
    </div>
                ...
                <tr id="table_row_<?php echo $scheme['id'] ?>">
                    ...
                    <td width="300px">
                        <?php $projects = UbirimiContainer::get()['repository']->get(
                            YongoProject::class
                        )->getByWorkflowSchemeId($scheme['id']) ?>
                        <?php if ($projects): ?>
                            <ul>
