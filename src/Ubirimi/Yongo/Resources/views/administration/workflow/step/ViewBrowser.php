...
<div class="pageContent">
    ...
    <ul class="nav nav-tabs" style="padding: 0px;">
        ...
        <li class="active"><a href="/yongo/administration/workflow/step-browser/<?php echo $stepId ?>">Workflow
                Browser</a></li>
    </ul>
        ...
        <tr>
            <td>
                ...
                $transitions = UbirimiContainer::get()['repository']->get(
                    Workflow::class
                )->getIncomingTransitionsForStep($workflow['id'], $stepId); ?>
                <?php if ($transitions): ?>
                    <table>
            ...
            <td valign="top">
                ...
                $transitions = UbirimiContainer::get()['repository']->get(
                    Workflow::class
                )->getOutgoingTransitionsForStep($workflow['id'], $stepId); ?>
                <?php if ($transitions): ?>
                    <table>
                        <?php while ($transition = $transitions->fetch_array(MYSQLI_ASSOC)): ?>
                            <tr>
