...
<div class="pageContent">
    ...
    <ul class="nav nav-tabs" style="padding: 0px;">
        <li class="active"><a href="/yongo/administration/workflow/view-transition/<?php echo $workflowDataId ?>">Summary</a>
        </li>
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td>
                <a href="/yongo/administration/workflow/edit-transition/<?php echo $workflowData['id'] ?>"
                   class="btn ubirimi-btn"><i class="icon-edit"></i> Edit</a>
    ...
    <table>
        <tr>
            <td>
                <div class="textLabel">Transition Name:</div>
            </td>
            <td><?php echo $workflowData['transition_name'] ?></td>
        </tr>
        <tr>
            <td>
                <div class="textLabel">Transition Description:</div>
            </td>
            <td><?php echo $workflowData['transition_description'] ?></td>
        </tr>
        <tr>
            <td>
                <div class="textLabel">Destination Step:</div>
            </td>
            <td><?php echo $workflowData['destination_step_name'] ?></td>
        </tr>
        <tr>
            <td>
                <div class="textLabel">Transition Screen:</div>
            </td>
            <td>
