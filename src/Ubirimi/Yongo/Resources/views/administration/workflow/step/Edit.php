...
<div class="pageContent">
    ...
    <form action="/yongo/administration/workflow/edit-step/<?php echo $stepId ?>?source=<?php echo $source ?>"
          name="edit_step" method="post">
        <table width="100%">
            <tr>
                ...
                <td>
                    <select name="status" class="select2InputSmall">
                        <?php while ($status = $statuses->fetch_array(MYSQLI_ASSOC)): ?>
                            <option <?php if ($status['id'] == $step['linked_issue_status_id']) echo 'selected="selected"' ?>
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="edit_step" class="btn ubirimi-btn"><i class="icon-edit"></i> Update
                            Step
                        </button>
                        <a class="btn ubirimi-btn"
                           href="/yongo/administration/workflow/view-step/<?php echo $stepId ?>">Cancel</a>
                    </div>
                </td>
            </tr>
        </table>
