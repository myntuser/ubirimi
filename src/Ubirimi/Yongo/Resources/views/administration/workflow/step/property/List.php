...
<div class="pageContent">
    ...
    <ul class="nav nav-tabs" style="padding: 0px;">
        ...
        <li class="active"><a href="/yongo/administration/workflow/view-step-properties/<?php echo $stepId ?>">Properties</a>
        </li>
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td>
                <a href="/yongo/administration/workflow/add-step-property/<?php echo $step['id'] ?>"
                   class="btn ubirimi-btn"><i class="icon-plus"></i> Add Property</a>
                <a href="#" id="btnEditStepProperty" class="btn ubirimi-btn disabled"><i class="icon-edit"></i> Edit</a>
                <a id="btnDeleteStepProperty" href="#" class="btn ubirimi-btn disabled"><i class="icon-remove"></i>
                    Delete</a>
            </td>
        </tr>
    </table>
