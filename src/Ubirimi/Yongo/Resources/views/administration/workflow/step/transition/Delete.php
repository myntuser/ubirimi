...
<div class="pageContent">
    ...
    <form action="/yongo/administration/workflow/delete-transitions/<?php echo $stepId ?>" method="post"
                ...
                <td>
                    <select name="transitions[]" size="10" class="inputTextCombo" multiple="multiple">
                        <?php while ($transitions && $transition = $transitions->fetch_array(MYSQLI_ASSOC)): ?>
                            <option
                                value="<?php echo $transition['id'] ?>"><?php echo $transition['transition_name'] ?></option>
                        <?php endwhile ?>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn ubirimi-btn"
                       href="/yongo/administration/workflow/view-as-text/<?php echo $workflowId ?>">Cancel</a>
                </td>
            </tr>
        </table>
    </form>
