...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td>
                <a href="/yongo/administration/workflow/edit-step/<?php echo $step['id'] ?>" class="btn ubirimi-btn"><i
                        class="icon-edit"></i> Edit</a>
                <a href="/yongo/administration/workflow/add-transition/<?php echo $step['id'] ?>"
                   class="btn ubirimi-btn">Add Outgoing Transition</a>
                <a id="btnDeleteStepOutgoingTransitions" href="#" class="btn ubirimi-btn"><i class="icon-remove"></i>
                    Delete Outgoing Transitions</a>
            </td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            <td>
                <div class="textLabel">Step Name:</div>
            </td>
            <td><?php echo $step['name'] ?></td>
        </tr>
        <tr>
            <td>
                <div class="textLabel">Linked Status:</div>
            </td>
