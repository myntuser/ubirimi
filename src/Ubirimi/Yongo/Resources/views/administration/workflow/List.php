...
<div class="pageContent">
    <?php if (Util::userHasYongoAdministrativePermission()): ?>
        ...
        <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
            <tr>
                <td>
                    <a id="btnNewProjectWorkflow" href="/yongo/administration/workflow/add" class="btn ubirimi-btn"><i
                            class="icon-plus"></i> Create Workflow</a>
                    ...
                    <a id="btnDeleteWorkflow" href="#" class="btn ubirimi-btn disabled"><i class="icon-remove"></i>
                        Delete</a>
            ...
            <table class="table table-hover table-condensed">
                ...
                <?php while ($workflow = $workflows->fetch_array(MYSQLI_ASSOC)): ?>
                    <tr id="table_row_<?php echo $workflow['id'] ?>">
                        ...
                        <td width="400px">
                            <?php $workflowSchemes = UbirimiContainer::get()['repository']->get(
