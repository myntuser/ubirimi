...
<div class="pageContent">
    ...
    <form name="add_post_function_data"
          action="/yongo/administration/workflow/transition-add-post-function-data/<?php echo $workflowDataId ?>?function_id=<?php echo $postFunctionId ?>"
          method="post">
                ...
                <tr>
                    ...
                    <td>
                        <select name="issue_field" class="select2InputSmall">
                            <option value="<?php
                            echo Field::FIELD_RESOLUTION_CODE ?>">Resolution
                            </option>
                        </select>
                    </td>
                </tr>
                    ...
                    <td align="left">
                        <div align="left">
                            ...
                            <a class="btn ubirimi-btn"
                               href="/yongo/administration/workflow/transition-post-functions/<?php echo $workflowDataId ?>">Cancel</a>
                        </div>
                    </td>
                </tr>
            </table>
