...
<div class="pageContent">
    ...
    <form name="add_post_function"
          action="/yongo/administration/workflow/add-condition-data/<?php echo $workflowDataId ?>" method="post">
                ...
                <td align="left" colspan="2">
                    ...
                    <div align="left">
                        ...
                        <a class="btn ubirimi-btn"
                           href="/yongo/administration/workflow/transition-conditions/<?php echo $workflowDataId ?>">Cancel</a>
                    </div>
                </td>
            </tr>
        </table>
