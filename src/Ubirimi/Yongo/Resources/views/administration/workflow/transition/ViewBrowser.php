...
<div class="pageContent">
    ...
    <ul class="nav nav-tabs" style="padding: 0px;">
        ...
        <li class="active"><a href="/yongo/administration/workflow/transition-browser/<?php echo $workflowDataId ?>">Workflow
                Browser</a></li>
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td>
                <?php $steps = UbirimiContainer::get()['repository']->get(
                    Workflow::class
                )->getOriginatingStepsForTransition($workflow['id'], $workflowData['transition_name']); ?>
                <?php if ($steps): ?>
                    <table>
            ...
            <td valign="top">
                <?php $steps = UbirimiContainer::get()['repository']->get(
                    Workflow::class
                )->getDestinationStepsForTransition($workflow['id'], $workflowData['transition_name']); ?>
                <?php if ($steps): ?>
                    <table>
                        <?php while ($step = $steps->fetch_array(MYSQLI_ASSOC)): ?>
                            <tr>
