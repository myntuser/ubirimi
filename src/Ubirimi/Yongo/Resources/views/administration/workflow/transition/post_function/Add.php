...
<div class="pageContent">
    ...
    <form name="add_post_function"
          action="/yongo/administration/workflow/transition-add-post-function/<?php echo $workflowDataId ?>"
          method="post">
        ...
        <table width="100%">
            <tr>
                <td align="left" colspan="2">
                    <hr size="1"/>
                    <div align="left">
                        <button type="submit" name="add_new_post_function" class="btn ubirimi-btn">Add Post Function
                        </button>
