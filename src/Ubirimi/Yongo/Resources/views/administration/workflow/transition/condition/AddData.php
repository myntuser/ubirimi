...
<div class="pageContent">
    <form name="add_cond_parameters"
          action="/yongo/administration/workflow/add-condition-data/<?php echo $workflowDataId ?>?condition_id=<?php echo $conditionId ?>"
          method="post">
        <?php if ($conditionId == WorkflowCondition::CONDITION_PERMISSION): ?>
            ...
            <table width="100%">
                        ...
                        <select name="permission" class="select2InputMedium">
                            <?php while ($category = $permissionCategories->fetch_array(MYSQLI_ASSOC)): ?>
                                <optgroup label="<?php echo $category['name'] ?>">
                                    <?php $permissions = UbirimiContainer::get()['repository']->get(
                                        Permission::class
                ...
                <tr>
                    ...
                    <td>
                        <div align="left">
                            <button type="submit" name="confirm_new_condition_parameter" class="btn ubirimi-btn">Add
                            </button>
                            <a class="btn ubirimi-btn"
                               href="/yongo/administration/workflow/add-condition/<?php echo $workflowDataId ?>">Cancel</a>
                        </div>
                    </td>
                </tr>
            </table>
