        ...
        <tr>
            <td>
                <div class="headerPageText">
                    <a class="linkNoUnderline" href="/yongo/administration/workflows">Workflows</a>
                    > <?php echo $workflow['name'] ?> > Edit
                </div>
            </td>
        </tr>
    </table>
    ...
    <form name="edit_workflow" action="/yongo/administration/workflow/edit/<?php echo $workflowId ?>" method="post">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea class="inputTextAreaLarge"
                              name="description"><?php echo $workflow['description'] ?></textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="let">
                    <div align="left">
                        <button type="submit" name="edit_workflow" class="btn ubirimi-btn"><i class="icon-edit"></i>
                            Update Workflow
                        </button>
