        ...
        <tr>
            ...
            <td>
                <div class="headerPageText">
                    <a class="linkNoUnderline" href="/yongo/administration/projects">Projects</a>
                    > <?php echo $project['name'] ?> > Components
                </div>
            </td>
            <td align="right">
...
<div class="pageContent">
    ...
    <ul class="nav nav-tabs" style="padding: 0px;">
        ...
        <li class="active"><a href="/yongo/administration/project/components/<?php echo $projectId ?>">Components</a>
        </li>
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a id="" href="/yongo/administration/project/component/add/<?php echo $projectId ?>"
                   class="btn ubirimi-btn"><i class="icon-plus"></i> Create component</a></td>
            <?php if ($components): ?>
                <td><a id="btnCreateSubcomponent" href="#" class="btn ubirimi-btn disabled">Create Sub-Component</a>
                </td>
                <td><a id="btnEditComponent" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i>
                        Edit</a></td>
                <td><a id="btnDeleteProjectComponent" href="#" class="btn ubirimi-btn disabled"><i
    ...
    <?php if ($components): ?>
        <table class="table table-hover table-condensed">
            ...
            <tbody>
            <?php UbirimiContainer::get()['repository']->get(YongoProject::class)->renderTreeComponents(
                $components,
                0
            ) ?>
            </tbody>
