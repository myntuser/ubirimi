...
<div class="pageContent">
    <form name="add_component"
          action="/yongo/administration/project/subcomponent/add/<?php echo $projectId ?>/<?php echo $parentComponentId ?>"
          method="post">
        ...
        <table width="100%">
                ...
                <td>
                    <select name="leader" class="select2InputSmall">
                        ...
                        <?php while ($user = $users->fetch_array(MYSQLI_ASSOC)): ?>
                            <option <?php if (isset($leader) && $leader == $user['id']) echo 'selected="selected"' ?>
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="confirm_new_component" class="btn ubirimi-btn"><i
                                class="icon-plus"></i> Create Component
                        </button>
