    ...
    <?php if ($accessToPage): ?>
        <?php if ($hasGlobalAdministrationPermission || $hasGlobalSystemAdministrationPermission): ?>
            <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
                <tr>
                    <td><a id="btnNew" href="/yongo/administration/project/add" class="btn ubirimi-btn"><i
                                class="icon-plus"></i> Create New Project</a></td>
                    <td><a id="btnEditClientProject" href="/yongo/administration/workflows/edit-scheme/"
                           class="btn ubirimi-btn disabled"><i class="icon-edit"></i> Edit</a></td>
                    <td><a id="btnDeleteClientProject" href="#" class="btn ubirimi-btn disabled"><i
