        ...
        <tr>
            ...
            <td>
                <div class="headerPageText">
                    ...
                    > <?php echo $project['name'] ?> > Versions
                </div>
            </td>
            <td align="right">
...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a id="" href="/yongo/administration/project/version/add/<?php echo $projectId ?>"
                   class="btn ubirimi-btn"><i class="icon-plus"></i> Create Version</a></td>
            <?php if ($releases): ?>
                <td><a id="btnEditRelease" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i> Edit</a>
                </td>
                <td><a id="btnDeleteRelease" href="#" class="btn ubirimi-btn disabled"><i class="icon-remove"></i>
                        Delete</a></td>
            <?php endif ?>
        </tr>
    </table>
