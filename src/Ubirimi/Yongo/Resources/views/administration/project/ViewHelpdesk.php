...
<div class="pageContent">
    ...
    <?php if ($project['help_desk_enabled_flag']): ?>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="top" width="50%">
                    <div class="headerPageText">
                        <a class="linkNoUnderline"
                           href="/helpdesk/queues/<?php echo $projectId ?>/<?php if (isset($queueSelected)) {
                               echo $queueSelected['id'];
                           } else {
                               echo '-1';
                           } ?>" title="Queues">Queues</a>
                    </div>
                ...
                <td valign="top">
                    <div class="headerPageText">
                        <a href="/helpdesk/sla/<?php echo $projectId ?>/<?php if (isset($slaSelected)) {
                            echo $slaSelected['id'];
                        } else {
                            echo '-1';
                        } ?>" title="SLA">SLA</a>
            ...
            <tr>
                <td valign="top">
                    <div class="headerPageText">
                        <a href="/helpdesk/customer-portal/administration/home/<?php echo $projectId ?>"
                           title="Customer Portal">Customer Portal</a>
                    </div>
        ...
        <div>
            ...
            <div>If you disable this service desk, your queues, reports, SLAs and customer portal will no longer be
                accessible. Issues created in the project and any linked knowledge bases are not affected.
                If you change your mind, you can use this page to restore the service desk. It will be restored with the
                configuration settings it had when you disabled it.
            </div>
    ...
    <?php else: ?>
        ...
        <a href="/yongo/administration/project/helpdesk/toggle/<?php echo $projectId ?>" class="btn ubirimi-btn">Enable
            Helpdesk</a>
    <?php endif ?>
</div>
