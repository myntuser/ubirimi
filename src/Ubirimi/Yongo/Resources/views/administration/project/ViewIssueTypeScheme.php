...
<div class="headerPageBackground">
    <table width="100%">
        <tr>
            ...
            <td>
                <div class="headerPageText"><a class="linkNoUnderline"
                                               href="/yongo/administration/projects">Projects</a>
                    > <?php echo $project['name'] ?> > <?php echo $issueTypeDefaultScheme['name'] ?></div>
            </td>
            <td align="right">
...
<div class="pageContent">
    ...
    <ul class="nav nav-tabs" style="padding: 0px;">
        ...
        <li class="active"><a href="/yongo/administration/project/issue-types/<?php echo $projectId ?>">Issue Types</a>
        </li>
    ...
    <?php if ($hasGlobalAdministrationPermission || $hasGlobalSystemAdministrationPermission): ?>
        <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
            <tr>
                <td><a href="/yongo/administration/issue/edit-type-scheme/<?php echo $issueTypeDefaultScheme['id'] ?>"
                       class="btn ubirimi-btn"><i class="icon-edit"></i> Edit Issue Types</a></td>
    ...
    <table class="table table-hover table-condensed">
        ...
        <?php while ($data = $issueTypeDefaultSchemeData->fetch_array(MYSQLI_ASSOC)): ?>
            <tr>
                ...
                <td>
                    <?php
                    $workflows = UbirimiContainer::get()['repository']->get(Workflow::class)->getByIssueType(
                        $data['issue_type_id'],
                        $clientId
                    );
                    if ($workflows) {
                ...
                <td>
                    ...
                    )->getByIssueType($data['issue_type_id'], $clientId);
                ...
                <td>
                    <?php
                    $screenSchemes = UbirimiContainer::get()['repository']->get(ScreenScheme::class)->getByIssueType(
                        $data['issue_type_id'],
                        $clientId
                    );
                    if ($screenSchemes) {
