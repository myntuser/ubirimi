    ...
    <table class="table table-hover table-condensed">
        ...
        <?php while ($role = $roles->fetch_array(MYSQLI_ASSOC)): ?>
            <tr id="table_row_<?php echo $role['id'] ?>">
                ...
                <td>
                    <?php
                    $users = UbirimiContainer::get()['repository']->get(YongoProject::class)->getUsersInRole(
                        $projectId,
                        $role['id']
                    );
                    $usersNames = array();
                ...
                <td>
                    <?php
                    $groups = UbirimiContainer::get()['repository']->get(YongoProject::class)->getGroupsInRole(
                        $projectId,
                        $role['id']
                    );
                    $groupNames = array();
