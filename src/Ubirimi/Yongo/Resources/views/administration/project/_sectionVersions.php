...
<table width="100%">
    <tr>
        <td id="sectProjectVersions" width="74%" class="sectionDetail" colspan="3"><span
                class="headerPageText sectionDetailTitle">Versions</span></td>
    </tr>
            ...
            <table width="100%" id="contentProjectVersions">
                ...
                <tr>
                    <td valign="top" width="330">
                        <?php
                        $versions = UbirimiContainer::get()['repository']->get(YongoProject::class)->getVersions(
                            array($projectId)
                        );
                        if ($versions) {
                        ...
                        ?>
                        <div>The project does not have any versions. <a
                                href="/yongo/administration/project/version/add/<?php echo $projectId ?>">Add
                                version</a></div>
