...
<div class="pageContent">
    ...
    <?php if ($hasGlobalAdministrationPermission || $hasGlobalSystemAdministrationPermission): ?>
        <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
            <tr>
                <td><a href="/yongo/administration/project/select-issue-type-field-scheme/<?php echo $projectId ?>"
    ...
    <?php while ($fieldConfiguration = $fieldConfigurations->fetch_array(MYSQLI_ASSOC)): ?>
        <table width="100%">
            <tr>
                <td colspan="2">
                    <div class="headerPageText"><?php echo $fieldConfiguration['name'] ?></div>
                </td>
            </tr>
            <tr>
                <td valign="top" width="180">
                    ...
                    )->getIssueTypesForFieldConfiguration(
                        ...
                        <?php while ($field = $allFields->fetch_array(MYSQLI_ASSOC)): ?>
                            <tr>
                                ...
                                <td align="left">
                                    ...
                                    <?php $screens = UbirimiContainer::get()['repository']->get(
                                        Screen::class
                                    )->getByFieldId($clientId, $field['id']) ?>
                                    <?php if ($screens): ?>
                                        <ul>
                                            <?php while ($screen = $screens->fetch_array(MYSQLI_ASSOC)): ?>
                                                <li>
                                                    <a href="/yongo/administration/screen/configure/<?php echo $screen['id'] ?>?source=project_field&project_id=<?php echo $project['id'] ?>"><?php echo $screen['name'] ?></a>
                                                </li>
                                            <?php endwhile ?>
                                        </ul>
                                    <?php endif ?>
