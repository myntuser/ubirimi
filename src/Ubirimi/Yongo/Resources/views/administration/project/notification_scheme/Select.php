...
<div class="pageContent">
    ...
    <form name="select_notification_scheme" method="post"
          action="/yongo/administration/project/notifications/select-project-notification-scheme/<?php echo $projectId ?>">
        <table width="100%">
            <tr>
                ...
                <td>
                    <select name="perm_scheme" class="select2InputMedium">
                        <?php while ($notificationScheme = $notificationSchemes->fetch_array(MYSQLI_ASSOC)): ?>
                            <option <?php if ($notificationScheme['id'] == $project['notification_scheme_id']) echo 'selected="selected"' ?>
                                value="<?php echo $notificationScheme['id'] ?>"><?php echo $notificationScheme['name'] ?></option>
                        <?php endwhile ?>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn ubirimi-btn"
                       href="/yongo/administration/project/permissions/<?php echo $projectId ?>">Cancel</a>
                </td>
            </tr>
        </table>
    </form>
