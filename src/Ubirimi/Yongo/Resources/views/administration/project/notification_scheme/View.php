        ...
        <tr>
            ...
            <td>
                <div class="headerPageText"><a href="/yongo/administration/projects"
                    ...
                    Notifications > <?php echo $notificationScheme['name'] ?></div>
            </td>
            <td align="right">
...
<div class="pageContent">
    ...
    <ul class="nav nav-tabs" style="padding: 0px;">
        ...
        <li class="active"><a
                href="/yongo/administration/project/notifications/<?php echo $projectId ?>">Notifications</a></li>
    ...
    <?php if ($hasGlobalAdministrationPermission || $hasGlobalSystemAdministrationPermission): ?>
        <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
            <tr>
                <td>
                    <a href="/yongo/administration/notification-scheme/edit/<?php echo $notificationScheme['id'] ?>?back=view_project_notification&project_id=<?php echo $projectId ?>"
                       class="btn ubirimi-btn"><i class="icon-edit"></i> Edit Notifications</a></td>
                <td>
                    <a href="/yongo/administration/project/notifications/select-project-notification-scheme/<?php echo $projectId ?>"
        ...
        <?php while ($notification = $events->fetch_array(MYSQLI_ASSOC)): ?>
            <tr>
                ...
                <td>
                    ...
                    )->getDataByNotificationSchemeIdAndEventId($notificationSchemeId, $notification['id']);
                    if ($notificationData) {
                        echo '<ul>';
