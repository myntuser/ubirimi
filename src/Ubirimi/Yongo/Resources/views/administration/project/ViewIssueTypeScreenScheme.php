...
<div class="pageContent">
    ...
    <?php if ($hasGlobalAdministrationPermission || $hasGlobalSystemAdministrationPermission): ?>
        <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
            <tr>
                <td><a href="/yongo/administration/project/select-issue-type-screen-scheme/<?php echo $projectId ?>"
    ...
    <?php while ($screenScheme = $screenSchemes->fetch_array(MYSQLI_ASSOC)): ?>
        <table width="100%">
            <tr>
                <td colspan="2">
                    <div class="headerPageText"><?php echo $screenScheme['name'] ?></div>
                </td>
            </tr>
            <tr>
                <td valign="top" width="180">
                    ...
                    )->getIssueTypesForScreenScheme($project['issue_type_screen_scheme_id'], $screenScheme['id']); ?>
                ...
                <td valign="top">
                    <?php $screenSchemeData = UbirimiContainer::get()['repository']->get(
                        ScreenScheme::class
                    )->getDataByScreenSchemeId($screenScheme['id']); ?>
                    ...
                    <table class="table table-hover table-condensed">
                        ...
                        <?php while ($data = $screenSchemeData->fetch_array(MYSQLI_ASSOC)): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/yongo/administration/screen/configure/<?php echo $data['screen_id'] ?>?source=project_screen&project_id=<?php echo $project['id'] ?>"><?php echo $data['screen_name']; ?></a>
                                </td>
                            </tr>
                        <?php endwhile ?>
                    </table>
