...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a id="btnNewFilterSubscription" class="btn ubirimi-btn"><i class="icon-plus"></i> Add Subscription</a>
            </td>
            <td><a id="btnEditFilterSubscription" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i>
                    Edit</a></td>
            <td><a id="btnDeleteFilterSubscription" href="#" class="btn ubirimi-btn disabled"><i
    ...
    <table class="table table-hover table-condensed">
        ...
        <?php while ($subscription = $subscriptions->fetch_array(MYSQLI_ASSOC)): ?>
            <tr id="table_row_<?php echo $subscription['id'] ?>">
                ...
                <td><a href="#">Edit</a> | <a
                        href="/yongo/filter/subscription/delete/<?php echo $subscription['id'] ?>">Delete</a></td>
            </tr>
        <?php endwhile ?>
        </tbody>
    </table>
