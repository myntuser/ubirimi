...
<div class="pageContent">
    ...
    <?php if ($allProjects == null && ($hasGlobalAdministrationPermission || $hasGlobalSystemAdministrationPermission)): ?>
        <div class="infoBox" style="margin-top: 4px;">
            <div>There are no projects created. You can create one by clicking <a class="linkNoUnderline"
                                                                                  href="/yongo/administration/project/add"><b>here</b></a>.
            </div>
        </div>
    <?php endif ?>
        ...
        <tr>
            <td width="49%" valign="top">
                <ul class="nav nav-tabs" style="padding: 0px;">
                    <li class="active"><a href="#" title="Created vs. Resolved Chart">Created vs. Resolved Chart</a>
                    </li>
                </ul>
                ...
                <div style="max-height: 700px; overflow: auto;">
                    <div style="border: 1px solid #d6d6d6; border-top: none;">
                        ...
                        if ($issues) {
                            ...
                            $issuesRendered = Util::renderIssueTables(
                                $renderParameters,
                                $renderColumns,
                                $clientSettings
                            );
            ...
            <td width="49%" valign="top">
                ...
                <br/>
                <?php if (UbirimiContainer::get()['repository']->get(UbirimiUser::class)->hasGlobalPermission(
                        $clientId,
                        $loggedInUserId,
                    ...
                    <div style="border: 1px solid #d6d6d6; border-top: none; padding: 8px;">
                        <table>
                            <tr>
                                <td><b>Projects</b></td>
                                <td><a href="/yongo/administration/projects">View All</a> or <a
                                        href="/yongo/administration/project/add">Create New</a></td>
                            </tr>
                            <tr>
                                <td><b>Users</b></td>
                                <td>Browse <a href="/yongo/administration/users">users</a>, <a
                                        href="/yongo/administration/groups">groups</a> or <a
                                        href="/general-settings/users/add">create new user</a></td>
                            </tr>
                        </table>
                    </div>
                <?php endif ?>
