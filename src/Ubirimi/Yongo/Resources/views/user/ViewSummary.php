    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            ...
            <?php if ($hasAdministrationGlobalPermission || $hasSystemAdministrationGlobalPermission): ?>
                <td><a href="/yongo/administration/user/project-roles/<?php echo $userId ?>" class="btn ubirimi-btn">View
                        Project Roles</a></td>
            <?php endif ?>
            <?php if ($userId == $loggedInUserId): ?>
                <td><a id="btnChangePreferences" href="#" class="btn ubirimi-btn"><i class="icon-edit"></i> Update
                        Preferences</a></td>
            <?php endif ?>
            <td>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="/yongo/issue/search?assignee=<?php echo $userId ?>&project=<?php echo implode(
                                '|',
                                $projectIds
                            ) ?>">Assigned</a>
                        </li>
                        <li>
                            <a href="/yongo/issue/search?assignee=<?php echo $userId ?>&project=<?php echo implode(
                                '|',
                                $projectIds
                            ) ?>&resolution=-2">Assigned & Open</a>
                        </li>
                        <li>
                            <a href="/yongo/issue/search?reporter=<?php echo $userId ?>&project=<?php echo implode(
                                '|',
                                $projectIds
                            ) ?>">Reported</a>
                        </li>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
            <td valign="top" width="40%">
                <table width="100%">
                    <tr>
                        <td colspan="2" class="sectionDetail"><span class="sectionDetailSimple headerPageText">User details</span>
                        </td>
                    </tr>
                    <tr>
                ...
                <table width="100%">
                    <tr>
                        <td colspan="2" class="sectionDetail"><span class="sectionDetailSimple headerPageText">Preferences</span>
                        </td>
                    </tr>
                    <tr>
                        <td width="200px;">
                ...
                <table width="100%">
                    <tr>
                        <td colspan="2" class="sectionDetail"><span class="sectionDetailSimple headerPageText">Unresolved Issues By Project</span>
                        </td>
                    </tr>
                    <?php if ($stats): ?>
                        <?php while ($row = $stats->fetch_array(MYSQLI_ASSOC)): ?>
                            <?php if ($row['name']): ?>
                                <tr>
                                    <td>
                                        <?php echo LinkHelper::getYongoIssueListPageLink(
                                            $row['name'],
                                            array(
                                                'page' => 1,
                                                'link_to_page' => '/yongo/issue/search',
                                                'sort' => 'created',
                                                'resolution' => '-2',
                                                'assignee' => $userId,
            ...
            <td valign="top">
                <table width="100%">
                    <tr>
                        <td colspan="2" class="sectionDetail"><span class="sectionDetailSimple headerPageText">Activity Stream</span>
                        </td>
                    </tr>
                </table>
