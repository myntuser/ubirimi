        ...
        <tr>
            <td>
                <div class="headerPageText">
                    <?php echo LinkHelper::getYongoProjectLink($projectId, $project['name']) ?> > <a
                        class="linkNoUnderline" href="/yongo/project/components/<?php echo $projectId ?>">Components</a>
...
<div class="pageContent">
    ...
    <table width="100%" cellpadding="2">
        <tr>
            <td colspan="3" class="sectionDetail"><span
                    class="sectionDetailSimple headerPageText">Issues: Unresolved</span></td>
        </tr>
    </table>
    <?php if ($issues): ?>
        <?php
        ...
        <?php if ($issuesResult[1] > 10): ?>
            <a href="/yongo/issue/search?project=<?php echo $projectId ?>&component=<?php echo $componentId ?>&resolution=-2">View
                All Issues</a>
        <?php endif ?>
    <?php else: ?>
        <div>None</div>
    ...
    <table width="100%" cellpadding="2">
        <tr>
            <td colspan="3" class="sectionDetail"><span class="sectionDetailSimple headerPageText">Issues: Update recently</span>
            </td>
        </tr>
    </table>
    <?php if ($issuesUpdatedRecently): ?>
        ...
        <?php if ($issuesResultUpdatedRecently[1] > 10): ?>
            <a href="/yongo/issue/search?project=<?php echo $projectId ?>&component=<?php echo $componentId ?>&resolution=-2&sort=updated&order=desc">View
                All Issues</a>
        <?php endif ?>
    <?php else: ?>
        <div>None</div>
