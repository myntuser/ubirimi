...
<div class="pageContent">
    ...
    <table width="100%" cellpadding="8" class="table table-hover table-condensed">
        ...
        <tr>
            <td valign="top">
                <div><a href="/yongo/project/reports/<?php echo $projectId ?>/chart-report/assignee/column">Chart
                        Report</a></div>
            </td>
            <td>
        ...
        <tr>
            <td valign="top">
                <div>
                    <a href="/yongo/project/reports/<?php echo $projectId ?>/work-done-distribution/<?php echo $dateFrom ?>/<?php echo $dateTo ?>">Work
                        done distribution</a></div>
            </td>
            <td>
