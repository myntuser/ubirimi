        ...
        <tr>
            ...
            <td>
                <div class="headerPageText"><?php echo $project['name'] ?> > <a
                        href="/yongo/project/reports/<?php echo $projectId ?>">Reports</a> > Chart
                </div>
            </td>
        </tr>
    </table>
        ...
        <table class="table table-hover table-condensed" style="width: 600px;" align="center">
            ...
            <?php foreach ($issuesAssignee as $assignee => $data): ?>
                <tr>
                    ...
                    <td>
                        <a href="/yongo/issue/search?project=<?php echo $projectId ?>&assignee=<?php echo $assignee ?>"><?php echo $data['issues_count'] ?></a>
                    </td>
                    <td>
                        <?php
