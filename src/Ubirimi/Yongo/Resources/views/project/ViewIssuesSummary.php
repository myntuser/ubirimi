                ...
                <table width="100%" cellpadding="2">
                    <tr>
                        <td colspan="2" class="sectionDetail"><span
                                class="sectionDetailSimple headerPageText">Filters</span></td>
                    </tr>
                    <tr>
                        <td>
    ...
    <table width="100%" cellpadding="8">
        <tr>
            <td valign="top" width="50%">
                <?php Util::renderComponentStatSection(
                    $statsPriority,
                    $count,
        ...
        <tr>
            <td valign="top" width="50%">
                <table width="100%" cellpadding="2">
                    <tr>
                        <td colspan="3" class="sectionDetail"><span class="sectionDetailSimple headerPageText">Unresolved by component</span>
                        </td>
                    </tr>
