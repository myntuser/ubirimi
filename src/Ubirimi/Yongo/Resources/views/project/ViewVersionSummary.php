...
<div class="pageContent">
    ...
    <?php if ($issues): ?>
        ...
        <?php if ($issuesResult[1] > 10): ?>
            <a href="/yongo/issue/search?project=<?php echo $projectId ?>&version=<?php echo $versionId ?>&resolution=-2">View
                All Issues</a>
        <?php endif ?>
    <?php else: ?>
        <div>None</div>
    ...
    <?php if ($issuesUpdatedRecently): ?>
        ...
        <?php if ($issuesResultUpdatedRecently[1] > 10): ?>
            <a href="/yongo/issue/search?project=<?php echo $projectId ?>&version=<?php echo $versionId ?>&resolution=-2&sort=updated&order=desc">View
                All Issues</a>
        <?php endif ?>
    <?php else: ?>
        <div>None</div>
