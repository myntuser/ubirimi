    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td width="33%" align="left"><a
                    href="/yongo/project/calendar/<?php echo $projectId ?>/<?php echo $previousMonth ?>/<?php echo $previousYear ?>"
                    class="btn ubirimi-btn"><?php echo $previousMonthName ?></a></td>
            <td width="33%" align="center">
                <div class="headerPageText"><?php echo $currentMonthName . ' ' . $year ?></div>
            </td>
            <td width="33%" align="right"><a
                    href="/yongo/project/calendar/<?php echo $projectId ?>/<?php echo $nextMonth ?>/<?php echo $nextYear ?>"
                    class="btn ubirimi-btn"><?php echo $nextMonthName ?></a></td>
        </tr>
    </table>
