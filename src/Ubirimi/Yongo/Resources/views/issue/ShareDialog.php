<table>
    <tr>
        <td>
            ...
            <input type="text" class="inputTextLarge"
                   value="https://<?php echo $subdomain ?>.ubirimi.net/yongo/issue/<?php echo $issueId ?>"
                   disabled="disabled"/>
        </td>
    </tr>
    <tr>
        <td>
            <div>User</div>
            <select style="width: 100%;" name="user_to_share[]" id="user_to_share" class="select2Input"
                    multiple="multiple">
