    ...
    <?php else: ?>
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                        ...
                        <table width="100%" class="table table-hover table-condensed">
                            <tr>
                                <td style="border-top: none;">
                                    <a href="/yongo/issue/search?project=<?php echo implode(
                                        '|',
                                        $projectsForBrowsing
                                    ) ?>&resolution=-2&assignee=<?php echo $loggedInUserId ?>">My Open Issues</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="/yongo/issue/search?project=<?php echo implode(
                                        '|',
                                        $projectsForBrowsing
                                    ) ?>&reporter=<?php echo $loggedInUserId ?>">Reported By Me</a>
                                </td>
                            </tr>
                ...
                <td width="10%" valign="top">
                    <div class="pageContent"
                         style="border-bottom: 0; padding: 10px; margin: 0; margin-right: 10px; border-radius: 0;">
                        <form name="search_form" action="/yongo/issue/search<?php if ($extraParametersURL) {
                            echo '?' . $extraParametersURL;
                        } ?>" method="post">
                                ...
                                <tr>
                                    <td align="right">
                                        ...
                                        <input class="btn ubirimi-btn"
                                               type="button"
                                               value="<?php if ($getFilter) {
                                                   echo 'Update';
                                               } else echo 'Save Filter' ?>"
