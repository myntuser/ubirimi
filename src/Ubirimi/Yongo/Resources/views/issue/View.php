...
<?php if ($issueValid): ?>
    ...
    <div class="pageContent">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td id="sectDetails" width="70%" class="sectionDetail" colspan="3"><span
                        class="sectionDetailTitle headerPageText">Details</span></td>
                <td width="20"></td>
                            ...
                            <tr>
                                <td id="sectTimeTracking" class="sectionDetail">
                                    ...
                                    <?php if ($hasWorkOnIssuePermission): ?>
                                        <img id="add_issue_log_work" src="/img/plus.png" class="headerPageText menu_img"
                                             height="20px"
                                             style=" padding-left: 4px; margin-top: 3px; float: right; text-align: right; background-color: #ffffff"/>
                                    <?php endif ?>
                                </td>
                            </tr>
                        </table>
                ...
                <td colspan="3" valign="top">
                    ...
                    <table width="100%">
                        <?php if (Util::deepInArray('description', $screenData)) : ?>
                            <tr>
                                <td id="sectDescription" class="sectionDetail" colspan="2"><span
                                        class="sectionDetailTitle headerPageText">Description</span></td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="contentDescription"><?php echo str_replace(
                                            "\n",
                                            '<br />',
                                            htmlentities($issue['description'])
                                        ) ?></div>
                                    <br/>
                                </td>
                            </tr>
                        ...
                        <?php if ($attachments): ?>
                            <?php Util::includePartial(
                                __DIR__ . '/_attachments.php',
                                array(
                        ...
                        <?php if ($issue['environment']): ?>
                            <tr>
                                <td id="sectEnvironment" class="sectionDetail" colspan="2"><span
                                        class="sectionDetailTitle headerPageText">Environment</span></td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="contentEnvironment"><?php echo str_replace(
                                            "\n",
                                            '<br />',
                                            htmlentities($issue['environment'])
                                        ) ?></div>
                                    <br/>
                                </td>
                            </tr>
...
<?php if ($issueValid): ?>
    ...
    <input type="hidden" value="<?php if ($linkIssueTypes) {
        echo "1";
    } else echo "0" ?>" id="link_possible"/>
    ...
    <input type="hidden" value="<?php if (isset($hasEditPermission)) {
        echo "1";
    } ?>" id="has_edit_permission"/>
    <input type="hidden" value="<?php if (isset($hasViewVotersAndWatchersPermission)) {
        echo "1";
    } ?>" id="has_view_voters_and_watchers_permission"/>
