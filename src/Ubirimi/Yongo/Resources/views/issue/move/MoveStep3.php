...
<div class="pageContent">
    ...
    <table width="100%">
        <tr>
            ...
            <td width="15px"></td>
            <td valign="top">
                <form name="move_issue_step_3" method="post"
                      action="/yongo/issue/move/fields/<?php echo $issue['id'] ?>">
                        ...
                        <table>
                            <?php if ($issueComponents): ?>
                                <tr>
                                    ...
                                    <td>
                                        <select name="new_component[]" multiple="multiple" class="select2Input"
                                                style="width: 300px">
                                            <?php while ($targetProjectComponents && $targetProjectComponent = $targetProjectComponents->fetch_array(
                                                    MYSQLI_ASSOC
                                                )): ?>
                                                <option
                                                    value="<?php echo $targetProjectComponent['id'] ?>"><?php echo $targetProjectComponent['name'] ?></option>
                                            <?php endwhile ?>
                                        </select>
                                    </td>
                                </tr>
                            ...
                            <?php if ($issueFixVersions): ?>
                                <tr>
                                    ...
                                    <td>
                                        <select name="new_fix_version[]" multiple="multiple" class="select2Input"
                                                style="width: 300px">
                                            <?php while ($targetVersions && $targetVersion = $targetVersions->fetch_array(
                                                    MYSQLI_ASSOC
                                                )): ?>
                                                <option
                                                    value="<?php echo $targetVersion['id'] ?>"><?php echo $targetVersion['name'] ?></option>
                                            <?php endwhile ?>
                                        </select>
                                    </td>
                                </tr>
                            ...
                            <?php if ($issueAffectedVersions): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="new_affects_version[]" multiple="multiple" class="select2Input"
                                                style="width: 300px">
                                            <?php while ($targetVersions && $targetVersion = $targetVersions->fetch_array(
                                                    MYSQLI_ASSOC
                                                )): ?>
