        ...
        <tr>
            <td valign="top" width="240px">
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td>
                            <a href="/yongo/issue/move/project/<?php echo $issue['id'] ?>">Select Project and Issue
                                Type</a></b>
                            <br/>
            ...
            <td width="15px"></td>
            <td valign="top">
                <form name="move_issue_step_4" method="post"
                      action="/yongo/issue/move/confirmation/<?php echo $issue['id'] ?>">
                    <b>Step 4 of 4: Confirm the move with all of the details you have just configured.</b>
                    <br>
                    Note: Sub-Tasks associated with this issue will lose data stored in fields not applicable in the
                    target.
                    <table width="100%">
                        <tr>
                            <td width="30%"></td>
                        ...
                        <?php if (($issueComponents && $issueComponents->num_rows) || ($newIssueComponents && $newIssueComponents->num_rows)): ?>
                            <tr>
                                <td>Components</td>
                                <td>
                                    <?php while ($issueComponents && $issueComponent = $issueComponents->fetch_array(
                                            MYSQLI_ASSOC
                                        )): ?>
                                ...
                                <td>
                                    <?php if ($newIssueComponents): ?>
                                        <?php while ($issueComponent = $newIssueComponents->fetch_array(
                                            MYSQLI_ASSOC
                                        )): ?>
                                            <?php echo $issueComponent['name'] ?>
                                        <?php endwhile ?>
                        ...
                        <?php if (($issueFixVersions && $issueFixVersions->num_rows) || ($issueFixVersions && $newIssueFixVersions->num_rows)): ?>
                            <tr>
                                <td>Fix Versions</td>
                                <td>
                                    <?php while ($issueFixVersions && $issueVersion = $issueFixVersions->fetch_array(
                                            MYSQLI_ASSOC
                                        )): ?>
                                ...
                                <td>
                                    <?php if ($newIssueFixVersions): ?>
                                        <?php while ($issueVersion = $newIssueFixVersions->fetch_array(
                                            MYSQLI_ASSOC
                                        )): ?>
                                            <?php echo $issueVersion['name'] ?>
                                        <?php endwhile ?>
                        ...
                        <?php if (($issueAffectedVersions && $issueAffectedVersions->num_rows) || ($issueAffectedVersions && $newIssueAffectsVersions->num_rows)): ?>
                            <tr>
                                ...
                                <td>
                                    <?php while ($issueAffectedVersions && $issueVersion = $issueAffectedVersions->fetch_array(
                                            MYSQLI_ASSOC
                                        )): ?>
                                        <?php echo $issueVersion['name'] ?>
                                    <?php endwhile ?>
                                ...
                                <td>
                                    <?php if ($newIssueFixVersions): ?>
                                        <?php while ($issueVersion = $newIssueAffectsVersions->fetch_array(
                                            MYSQLI_ASSOC
                                        )): ?>
                                            <?php echo $issueVersion['name'] ?>
                                        <?php endwhile ?>
                        ...
                        <?php endif ?>
                        <?php if ($session->get('move_issue/new_assignee') && $issue['assignee'] != $session->get(
                                'move_issue/new_assignee'
                            )
                        ): ?>
                            <tr>
                                <td>Assignee</td>
                    ...
                    <div align="left">
                        ...
                        <a class="btn ubirimi-btn"
                           href="<?php echo LinkHelper::getYongoIssueViewLinkJustHref($issue['id']) ?>">Cancel</a>
                    </div>
