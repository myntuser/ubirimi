...
<div class="pageContent">
    <table width="100%">
        <tr>
            ...
            <td width="15px"></td>
            <td valign="top">
                <form name="move_issue_step_1" method="post"
                      action="/yongo/issue/move/project/<?php echo $issue['id'] ?>">
                        ...
                        <tr>
                            ...
                            <td width="25%">
                                <select name="move_to_project" id="move_to_project" class="select2InputSmall">
                                    <?php while ($projectForMoving && $project = $projectForMoving->fetch_array(
                                            MYSQLI_ASSOC
                                        )): ?>
                        ...
                        <tr>
                            ...
                            <td width="25%">
                                <select name="move_to_issue_type" id="move_to_issue_type" class="select2InputSmall">
                                    <?php while ($moveToIssueTypes && $issueType = $moveToIssueTypes->fetch_array(
                                            MYSQLI_ASSOC
                                        )): ?>
                                        <option
