        ...
        <table width="100%" class="table table-hover table-condensed" id="contentSubTasks">
            ...
            <?php while ($childIssue = $childrenIssues->fetch_array(MYSQLI_ASSOC)): ?>
                <tr>
                    ...
                    <td>
                        <img
                            title="<?php echo $issue['priority_name'] . ' - ' . $childIssue['issue_priority_description'] ?>"
                            height="16px"
                    ...
                    <td style="text-align: right; width: 200px;">
                        <?php echo LinkHelper::getUserProfileLink(
                            ...
                            $childIssue['ua_first_name'],
                            $childIssue['ua_last_name']
                        ) ?>
                    </td>
                        ...
                        <div class="btn-group" align="right">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <?php if ($childIssue['assignee'] != $loggedInUserId): ?>
                                    <li><a id="agile_plan_assign_to_me_<?php echo $childIssue['id'] ?>_1" href="#">Assign
                                            to Me</a></li>
                                <?php endif ?>
                                <li>
                                    <a id="agile_plan_assign_other_<?php echo $childIssue['id'] ?>_<?php echo $childIssue['issue_project_id'] ?>_<?php echo $childIssue['assignee'] ?>_1"
                                       href="#">Assign</a></li>
                            </ul>
                        </div>
                    </td>
