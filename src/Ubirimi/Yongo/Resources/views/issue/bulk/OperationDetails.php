...
<div class="pageContent">
    <form action="/yongo/issue/bulk-operation-details" method="post" name="bulk_operation">
        <ul class="nav nav-tabs" style="padding: 0px;">
            <li><a href="/yongo/issue/bulk-choose?<?php echo $session->get('bulk_change_choose_issue_query_url') ?>">Choose
                    Issues</a></li>
        ...
        <div class="description">By selecting this option, an update notification will be sent for each issue affected
            by this bulk operation
        </div>
        <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
            <tr>
                <td>
                    <button type="submit" class="btn ubirimi-btn" style="margin-left: 0px" name="next_step_4">Next
                        Step
                    </button>
