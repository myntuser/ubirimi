    ...
    <form action="/yongo/issue/bulk-operation" method="post" name="bulk_operation">
        ...
        <form name="choose_operation" method="post" action="/yongo/issue/bulk-operation">
            <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
                <tr>
                    <td>
                        <button type="submit" class="btn ubirimi-btn" style="margin-left: 0px" name="next_step_3">Next
                            Step
                        </button>
                    ...
                    <tr>
                        <td width="30">
                            <?php if ($deletePermissionInAllProjects): ?>
                                <input checked="checked" id="operation_delete" type="radio" value="Delete Issues"
