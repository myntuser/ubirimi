...
<div class="pageContent">
    ...
    <form action="/yongo/issue/bulk-change-confirmation" method="post" name="bulk_operation">
        ...
        <?php if ($session->get('bulk_change_operation_type') == 'delete'): ?>
            ...
            <div>Please confirm that you wish to delete the following <?php echo count(
                    $session->get('bulk_change_issue_ids')
                ) ?> issues.
            </div>
            ...
            <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
                <tr>
                    <td>
                        <button type="submit" class="btn ubirimi-btn" style="margin-left: 0px" name="confirm">Confirm
                        </button>
