...
class PermissionScheme
{
    ...
    )
    {
        ...
        $permissionSchemeRepository->addRoleDataToPermissionId(
            $permissionSchemeId,
            Permission::PERM_ADMINISTER_PROJECTS,
            array($roleAdministratorsId),
            $currentDate
        );
        $permissionSchemeRepository->addRoleDataToPermissionId(
            $permissionSchemeId,
        ...
        $permissionSchemeRepository->addRoleDataToPermissionId(
            $permissionSchemeId,
            Permission::PERM_DELETE_ALL_ATTACHMENTS,
            array($roleAdministratorsId),
            $currentDate
        );
        $permissionSchemeRepository->addRoleDataToPermissionId(
    ...
    {
        $permissionSchemes = UbirimiContainer::get()['repository']->get(PermissionScheme::class)->getByClientId(
            $clientId
        );
        while ($permissionSchemes && $permissionScheme = $permissionSchemes->fetch_array(MYSQLI_ASSOC)) {
            UbirimiContainer::get()['repository']->get(PermissionScheme::class)->deleteDataByPermissionSchemeId(
                $permissionScheme['id']
            );
