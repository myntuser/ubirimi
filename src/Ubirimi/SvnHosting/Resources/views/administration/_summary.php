...
<table width="100%">
    <tr>
        <td id="sectIssueTypes" width="74%" class="sectionDetail" colspan="3"><span
                class="headerPageText sectionDetailTitle">Description</span></td>
    </tr>
    <tr>
        <td>
            <table>
                <tr>
                    ...
                    <td><?php echo UbirimiContainer::get()['subversion.url'] . Util::slugify(
                                $session->get('client/company_domain')
                            ) . '/' . Util::slugify($svnRepo['name']) . '/trunk' ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo Util::getFormattedDate(
                            $svnRepo['date_created'],
