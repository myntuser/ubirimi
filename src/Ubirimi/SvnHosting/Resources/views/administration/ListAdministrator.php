...
<div class="pageContent">
    <?php if ($isSVNAdministrator): ?>
        ...
        <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
            <tr>
                <td><a id="btnNew" href="/svn-hosting/administration/add-administrator" class="btn ubirimi-btn"><i
                            class="icon-plus"></i> Add Administrator</a></td>
                <td><a id="btnDeleteSvnAdministrator" href="#" class="btn ubirimi-btn disabled"><i
        ...
        <?php if (!empty($svnAdministrators)): ?>
            ...
            <input type="hidden" value="<?php if ($svnAdministrators && $svnAdministrators->num_rows == 1) {
                echo '0';
            } else echo "1" ?>" id="delete_possible"/>
        <?php else: ?>
