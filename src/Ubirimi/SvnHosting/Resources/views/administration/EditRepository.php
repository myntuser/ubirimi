...
<div class="headerPageBackground">
    <table width="100%">
        <tr>
            <td>
                <div class="headerPageText"><a href="/svn-hosting/administration/all-repositories"
                                               class="linkNoUnderline">SVN Repositories</a>
                    > <?php echo $svnRepo['name'] ?> > Edit
                </div>
            </td>
        </tr>
    </table>
...
<div class="pageContent">
    <form name="edit_svn_repository" action="/svn-hosting/administration/repository/edit/<?php echo $repoId ?>"
          method="post">
        <table width="100%">
            <tr>
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="confirm_edit_svn_repository" class="btn ubirimi-btn"><i
                                class="icon-edit"></i> Edit SVN Repository
                        </button>
