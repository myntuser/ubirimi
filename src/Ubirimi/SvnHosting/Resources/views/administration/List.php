...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td>
                <a id="btnNew" href="/svn-hosting/administration/repository/add" class="btn ubirimi-btn"><i
                        class="icon-plus"></i> Create New SVN Repository</a>
            </td>
            <td>
                <a id="btnEditSvnRepo" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i> Edit</a>
            </td>
            <td>
                <a id="btnDeleteSvnRepo" href="#" class="btn ubirimi-btn disabled"><i class="icon-remove"></i>
                    Delete</a>
            </td>
        </tr>
    </table>
