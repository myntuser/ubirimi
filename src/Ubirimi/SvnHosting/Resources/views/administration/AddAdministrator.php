        ...
        <tr>
            <td>
                <div class="headerPageText"><a class="linkNoUnderline"
                                               href="/svn-hosting/administration/administrators">SVN Administrators</a>
                    > Add Administrator
                </div>
            </td>
        </tr>
    ...
    <form name="add_svn_administrator" action="/svn-hosting/administration/add-administrator" method="post">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="confirm_new_svn_administrator" class="btn ubirimi-btn">Add SVN
                            Administrators
                        </button>
