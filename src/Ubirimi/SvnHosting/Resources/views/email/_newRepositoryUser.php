...
?>
    ...
    <div
        style="font: Trebuchet MS, sans-serif; white-space: nowrap; padding-top: 5px;text-align: left;padding-left: 2px;">
        ...
        <br/>
        Repository URL: <?php echo UbirimiContainer::get()['subversion.url'] . Util::slugify(
                $this->clientData['company_domain']
            ) . '/' . Util::slugify($this->repoName) . '/trunk' ?>
        <br/>
