...
<div class="form-section clearfix sectionFeature blue" style="width: 300px">
    ...
    <fieldset>
        ...
        <input class="inputTextTall" type="password" value="<?php if (isset($password)) echo $password ?>"
               name="password"/>
    ...
    <fieldset>
        ...
        <input class="inputTextTall" type="password" value="<?php if (isset($passwordAgain)) echo $passwordAgain ?>"
               name="password_again"/>
    ...
    <fieldset>
        ...
        <input class="inputTextTall" type="text" name="first_name"
    ...
    <fieldset>
        ...
        <input class="inputTextTall" type="text" name="last_name"
