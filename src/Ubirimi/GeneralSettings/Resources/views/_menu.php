...
<?php if ($session->get('selected_product_id') == -1): ?>
        ...
        <tr>
            <td>
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="menuItemBasic <?php if ($menuSelectedCategory == 'general_home') {
                            echo 'menuItemSelected';
                        } else echo 'menuItem' ?>" id="menuHomeOverview">
                            <span><a style="<?php if ($menuSelectedCategory == 'general_home') {
                                    echo 'color: black';
                                } else echo 'color: white;' ?>" href="/general-settings/home" class="linkNoUnderline">Home</a></span>
                            &nbsp;
                        </td>
                        <?php if (Util::userHasClientAdministrationPermission()): ?>
                            <td class="menuItemBasic <?php if ($menuSelectedCategory == 'general_overview') {
                                echo 'menuItemSelected';
                            } else echo 'menuItem' ?>" id="menuHomeGeneral">
                                <span>Overview</span>
                                <span class="<?php if ($menuSelectedCategory == 'general_overview') {
                                    echo 'arrowSelected';
                                } else echo 'arrow' ?>"></span>
                                &nbsp;
                            </td>
                            <td width="8px"></td>
                            <td align="center" class="menuItemBasic <?php if ($menuSelectedCategory == 'general_mail') {
                                echo 'menuItemSelected';
                            } else echo 'menuItem' ?>" id="menuMailGeneral">
                                <span>Mail</span>
                                <span class="<?php if ($menuSelectedCategory == 'general_mail') {
                                    echo 'arrowSelected';
                                } else echo 'arrow' ?>"></span>
                                &nbsp;
                            </td>
                        <?php endif ?>
                        <td width="8px"></td>
                        <td align="center" class="menuItemBasic <?php if ($menuSelectedCategory == 'general_user') {
                            echo 'menuItemSelected';
                        } else echo 'menuItem' ?>" id="menuUsersGeneral">
                            <span>Users</span>
                            <span class="<?php if ($menuSelectedCategory == 'general_user') {
                                echo 'arrowSelected';
                            } else echo 'arrow' ?>"></span>
                            &nbsp;
                        </td>
    ...
    <div id="contentMenuHomeGeneral" style="display: none;">
        <table cellspacing="0" cellpadding="0" border="0" class="tableMenu" width="100%">
            ...
            <tr>
                <td>
                    <div><a class="linkSubMenu"
                            href="/general-settings/logs/<?php echo $filterLogFrom ?>/<?php echo $filterLogTo ?>">Logs</a>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div id="contentMenuMailGeneral" style="display: none;">
        <table cellspacing="0" cellpadding="0" border="0" class="tableMenu" width="100%">
            <tr>
                <td>
                    <div><a class="linkSubMenu" href="/general-settings/smtp-settings">SMTP Settings&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div><a class="linkSubMenu" href="/general-settings/main-queue">Mail Queue&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                    </div>
                </td>
            </tr>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#6A8EB2"
        ...
        <tr>
            <td>
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="menuItemBasic <?php if ($menuSelectedCategory == 'ubirimi_about') {
                            echo 'menuItemSelected';
                        } else echo 'menuItem' ?>" id="menuUbirimiAbout">
                            <span><a style="<?php if ($menuSelectedCategory == 'ubirimi_about') {
                                    echo 'color: black';
                                } else echo 'color: white;' ?>" href="/ubirimi/about" class="linkNoUnderline">About</a></span>
                            &nbsp;
                        </td>
