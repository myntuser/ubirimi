...
<div class="pageContent">
    <form name="add_profile_category" action="/general-settings/users/profile-manager/category/add" method="post">
        <?php Util::renderBreadCrumb(
            '<a class="linkNoUnderline" href="/general-settings/users/profile-manager">Profile Manager</a> > Create Profile Category'
        ) ?>
        ...
        <table>
            ...
            <tr>
                <td></td>
                <td align="left">
                    <button type="submit" name="new_profile_category" class="btn ubirimi-btn"><i class="icon-plus"></i>
