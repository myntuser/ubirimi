<table width="100%">
    ...
    <tr>
        ...
        <td>
            <select id="user_notify_own_changes" class="select2InputSmall" style="width: 80px"
                    name="notify_own_changes">
                <option <?php if ($settings['notify_own_changes_flag']) echo 'selected="selected"' ?> value="1">YES
                </option>
                <option <?php if (!$settings['notify_own_changes_flag']) echo 'selected="selected"' ?> value="0">NO
                </option>
            </select>
        </td>
    </tr>
        ...
        <td>
            <select name="user_country" id="user_country" class="select2InputMedium">
                <?php while ($country = $countries->fetch_array(MYSQLI_ASSOC)): ?>
                    <option <?php if ($country['id'] == $settings['country_id']) echo 'selected="selected"' ?>
