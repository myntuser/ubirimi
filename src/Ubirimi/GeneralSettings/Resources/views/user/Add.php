        ...
        <form id="form_add_user" name="add_user" action="/general-settings/users/add" method="post">
            <table width="100%">
                <tr>
                    ...
                    <td>
                        <input class="inputText" type="text" value="<?php if (isset($username)) echo $username ?>"
                               name="username"/>
                ...
                <tr>
                    ...
                    <td>
                        <input class="inputText" type="password" value="<?php if (isset($password)) echo $password ?>"
                               name="password"/>
                ...
                <tr>
                    ...
                    <td>
                        <input class="inputText" type="password"
                               value="<?php if (isset($passwordAgain)) echo $passwordAgain ?>" name="password_again"/>
                ...
                <tr>
                    ...
                    <td>
                        <input class="inputText" type="text" value="<?php if (isset($email)) echo $email ?>"
                               name="email"/>
                ...
                <tr>
                    ...
                    <td>
                        <input class="inputText" type="text" name="first_name"
                ...
                <tr>
                    ...
                    <td>
                        <input class="inputText" type="text" name="last_name"
                    ...
                    <td style="vertical-align: middle">
                        ...
                        <?php else: ?>
                            <a class="btn ubirimi-btn"
                               href="/svn-hosting/administration/repository/users/<?php echo $svnRepoId ?>">Cancel</a>
                        <?php endif ?>
                    </td>
                </tr>
            </table>
