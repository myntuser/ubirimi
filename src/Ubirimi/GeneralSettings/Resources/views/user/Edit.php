...
<div class="pageContent">
    <?php if (Util::userHasClientAdministrationPermission()): ?>
        <form id="form_edit_user" name="edit_user"
              action="/general-settings/users/edit/<?php echo $userId ?>?location=<?php echo $location ?>"
              method="post">

            <table width="100%">
                <tr>
                    <td id="sectDetails" class="sectionDetail" colspan="2"><span
                            class="sectionDetailTitleNoPicture headerPageTextSmall">Details</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td id="sectDetails" class="sectionDetail" colspan="2"><span
                            class="sectionDetailTitleNoPicture headerPageTextSmall">Permissions</span></td>
                </tr>
                <tr>
                    <td valign="top">Client Administrator</td>
                    <td>
                        <input type="checkbox" value="1"
                               name="client_administrator_flag" <?php if ($user['client_administrator_flag']) echo 'checked="checked"' ?> />
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" value="1"
                               name="customer_service_desk_flag" <?php if ($user['customer_service_desk_flag']) echo 'checked="checked"' ?> />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    ...
                    <td align="right">
                        <div align="left">
                            <button type="submit" class="btn ubirimi-btn" name="confirm_update_user">Update User
                            </button>
