...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a href="/general-settings/users/profile-manager/category/add" class="btn ubirimi-btn"><i
                        class="icon-plus"></i> Create Category</a></td>
            <td><a id="btnEditProfileCategory" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i> Edit</a>
            </td>
            <td><a id="btnUpdateUserProfileFields" href="#" class="btn ubirimi-btn disabled">Update Fields</a></td>
            <td><a id="btnDeleteProfileCategory" href="#" class="btn ubirimi-btn disabled"><i class="icon-remove"></i>
                    Delete</a></td>
        </tr>
    </table>
