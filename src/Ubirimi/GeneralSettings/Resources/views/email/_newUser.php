...
?>
    ...
    <div
        style="color: #333333; font: 17px Trebuchet MS, sans-serif; white-space: nowrap; padding-top: 5px;text-align: left;padding-left: 2px;">
        ...
        <?php if (isset($this->isCustomer) && $this->isCustomer): ?>
            <a href="<?php echo $httpHOST ?>/helpdesk/customer-portal"><?php echo $httpHOST ?>
