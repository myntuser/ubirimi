        ...
        <form name="edit_configuration" method="post" action="/general-settings/edit-general">
            ...
            <table width="100%" cellspacing="0">
                ...
                <tr>
                    ...
                    <td width="10"></td>
                    <td>
                        <input class="inputText" type="text" value="<?php echo $clientSettings['title_name'] ?>"
                               name="title_name"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select name="mode" class="select2InputSmall" style="width: 100px">
                            <option
                                value="private" <?php if ($clientSettings['operating_mode'] == 'private') echo 'selected="selected"' ?>>
                                Private
                            </option>
                            <option
                                value="public" <?php if ($clientSettings['operating_mode'] == 'public') echo 'selected="selected"' ?>>
                                Public
                            </option>
                        </select>
                ...
                <tr>
                    ...
                    <td width="10"></td>
                    <td>
                        <input class="inputText" readonly="readonly" type="text"
                               value="https://<?php echo $client['company_domain'] ?>.ubirimi.net" name="base_url"/>
                    </td>
                </tr>
            </table>
            <br/>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select name="continent" class="select2InputSmall" id="continent_time_zone">
                            <option value="1" <?php if ($timezoneContinent == 'Africa') echo 'selected="selected"' ?>>
                                Africa
                            </option>
                            <option value="2" <?php if ($timezoneContinent == 'America') echo 'selected="selected"' ?>>
                                America
                            </option>
                            <option
                                value="4" <?php if ($timezoneContinent == 'Antarctica') echo 'selected="selected"' ?>>
                                Antarctica
                            </option>
                            <option value="8" <?php if ($timezoneContinent == 'Arctic') echo 'selected="selected"' ?>>
                                Arctic
                            </option>
                            <option value="16" <?php if ($timezoneContinent == 'Asia') echo 'selected="selected"' ?>>
                                Asia
                            </option>
                            <option
                                value="32" <?php if ($timezoneContinent == 'Atlantic') echo 'selected="selected"' ?>>
                                Atlantic
                            </option>
                            <option
                                value="64" <?php if ($timezoneContinent == 'Australia') echo 'selected="selected"' ?>>
                                Australia
                            </option>
                            <option value="128" <?php if ($timezoneContinent == 'Europe') echo 'selected="selected"' ?>>
                                Europe
                            </option>
                            <option value="256" <?php if ($timezoneContinent == 'Indian') echo 'selected="selected"' ?>>
                                Indian
                            </option>
                            <option
                                value="512" <?php if ($timezoneContinent == 'Pacific') echo 'selected="selected"' ?>>
                                Pacific
                            </option>
                        </select>
                        <span>Timezone</span>
                        <select name="zone" class="select2InputSmall" id="general_settings_zone">
                            ...
                            for ($i = 0; $i < count($zones); $i++) {
                                ...
                                echo '<option ' . $textSelected . ' value="' . $zones[$i] . '">' . str_replace(
                                        array("Africa/", "_"),
                                        array("", " "),
                                        $zones[$i]
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="left">
                        <button type="submit" name="update_configuration" class="btn ubirimi-btn"><i
                                class="icon-edit"></i> Update Configuration
                        </button>
