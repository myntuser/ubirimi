    ...
    <table width="100%">
        <?php if (Util::userHasClientAdministrationPermission()): ?>
            ...
            <tr>
                <td width="20">
                    <input class="app_client" type="checkbox" value="1"
                           name="yongo" <?php if (Util::checkKeyAndValueInArray(
                        'sys_product_id',
            ...
            <tr>
                <td width="20">
                    <input class="app_client" type="checkbox" value="1"
                           name="agile" <?php if (Util::checkKeyAndValueInArray(
                        'sys_product_id',
            ...
            <tr>
                <td width="20">
                    <input class="app_client" type="checkbox" value="1"
                           name="helpdesk" <?php if (Util::checkKeyAndValueInArray(
                        'sys_product_id',
            ...
            <tr>
                <td width="20">
                    <input class="app_client" type="checkbox" value="1"
                           name="svn" <?php if (Util::checkKeyAndValueInArray(
                        'sys_product_id',
            ...
            <tr>
                <td width="20">
                    <input class="app_client" type="checkbox" value="1"
                           name="documentador" <?php if (Util::checkKeyAndValueInArray(
                        'sys_product_id',
            ...
            <tr>
                <td width="20">
                    <input class="app_client" type="checkbox" value="1"
                           name="events" <?php if (Util::checkKeyAndValueInArray(
                        'sys_product_id',
