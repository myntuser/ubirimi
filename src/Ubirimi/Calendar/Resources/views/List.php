...
<div class="pageContent">
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            ...
            <td><a id="btnEditCalendar" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i> Edit</a>
            </td>
            ...
            <td><a id="btnDeleteCalendar" href="#" class="btn ubirimi-btn disabled"><i class="icon-remove"></i>
                    Delete</a></td>
        </tr>
    </table>
