...
<div class="pageContent">
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            ...
            <?php if ($myEvent): ?>
                <td><a href="/calendar/edit/event/<?php echo $eventId ?>?source=<?php echo $sourcePageLink ?>"
...
<input type="hidden" value="<?php echo 'calendar/view/' . $event['calendar_id'] . '/' . $month . '/' . $year ?>"
       id="calendar_link"/>
