...
<div class="pageContent">
    ...
    <form name="edit_event" action="/calendar/edit/event/<?php echo $eventId ?>?source=<?php echo $sourcePageLink ?>"
          method="post">
        <table width="100%">
            <tr>
                <td>Calendar:</td>
                    ...
                    <select name="calendar" class="select2Input">
                        <?php foreach ($calendars as $calendar): ?>
                            <option <?php if ($event['calendar_id'] == $calendar['id'])
                                ...
                                value="<?php echo $calendar['id'] ?>"><?php echo $calendar['name'] ?></option>
                        <?php endforeach ?>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <textarea class="inputTextAreaLarge"
                              name="description"><?php echo $event['description'] ?></textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input class="inputText color {hash:true}" style="width: 100px" name="color"
                           value="<?php echo $event['color'] ?>"/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                    <select id="add_event_repeat_type" name="add_event_repeat_type" class="select2InputSmall">
                        ...
                        <option <?php if (RepeatCycle::REPEAT_DAILY == $defaultEventRepeatCycle) echo 'selected="selected"' ?>
                            value="1">Daily
                        </option>
                        <option <?php if (RepeatCycle::REPEAT_WEEKLY == $defaultEventRepeatCycle) echo 'selected="selected"' ?>
                            value="2">Weekly
                        </option>
                    </select>
                </td>
                    ...
                    <div id="content_event_reminders">
                        ...
                        <?php while ($eventReminders && $eventReminder = $eventReminders->fetch_array(MYSQLI_ASSOC)): ?>
                            <div id="reminder_content_<?php echo $eventReminder['id'] ?>">
                                <select name="reminder_type_<?php echo $eventReminder['id'] ?>"
                                        class="select2InputSmall">
                                    <option value="<?php
                                    echo ReminderType::REMINDER_EMAIL ?>">Email
                                    </option>
                                </select>
                                &nbsp;
                                <input type="text"
                                       ...
                                       style="width: 50px;"/>
                                &nbsp;
                                <select name="reminder_period_<?php echo $eventReminder['id'] ?>"
                                        class="select2InputSmall">
                                    <option <?php
                                    if ($eventReminder['cal_event_reminder_period_id'] == ReminderPeriod::PERIOD_MINUTE) echo 'selected="selected"' ?>
                                        value="<?php echo ReminderPeriod::PERIOD_MINUTE ?>">minutes
                                    </option>
                                    <option <?php
                                    if ($eventReminder['cal_event_reminder_period_id'] == ReminderPeriod::PERIOD_HOUR) echo 'selected="selected"' ?>
                                        value="<?php echo ReminderPeriod::PERIOD_HOUR ?>">hours
                                    </option>
                                    <option <?php
                                    if ($eventReminder['cal_event_reminder_period_id'] == ReminderPeriod::PERIOD_DAY) echo 'selected="selected"' ?>
                                        value="<?php echo ReminderPeriod::PERIOD_DAY ?>">days
                                    </option>
                                    <option <?php
                                    if ($eventReminder['cal_event_reminder_period_id'] == ReminderPeriod::PERIOD_WEEK) echo 'selected="selected"' ?>
                                        value="<?php
                                        echo ReminderPeriod::PERIOD_WEEK ?>">weeks
                                    </option>
                                </select>
                                <img src="/img/delete.png" id="delete_reminder_<?php echo $eventReminder['id'] ?>"
            ...
            <?php if ($repeatDaily || $repeatWeekly): ?>
                <tr>
                    ...
                    <td>
                        <input type="radio" name="change_event" id="event_recurring_this_event" value="this_event"
                               checked="checked">
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="edit_event" class="btn ubirimi-btn"><i class="icon-edit"></i> Update
                            Event
                        </button>
        ...
        <input type="hidden" id="initial_cal_event_edit_date_from"
               value="<?php echo date('Y-m-d H:i', strtotime($event['date_from'])); ?>"/>
        <input type="hidden" id="initial_cal_event_edit_date_to"
               value="<?php echo date('Y-m-d H:i', strtotime($event['date_to'])); ?>"/>
    </form>
</div>
