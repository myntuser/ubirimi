    ...
    <td>
        <table id="add_event_repeat_daily_content" style="display: none;">
            <tr>
                <td>Repeat every</td>
                <td>
                    <select id="add_event_repeat_every_daily" name="add_event_repeat_every_daily" class="inputTextCombo"
                            style="width: 50px">
                        <?php for ($i = 1; $i <= 30; $i++): ?>
                            <option <?php if ($repeatDaily && $defaultEventRepeatEvery == $i) echo 'selected="selected"' ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="radio"
                           value="after"
                           name="repeat_data_daily"
                        <?php if ($repeatDaily && $defaultEventEndAfterOccurrences) {
                    ...
                    <input
                        value="<?php if ($repeatDaily && $defaultEventEndAfterOccurrences) echo $defaultEventEndAfterOccurrences ?>"
                        type="text"
                        class="inputText"
                        style="width: 30px"
        ...
        <table id="add_event_repeat_weekly_content" style="display: none;">
            <tr>
                <td>Repeat every</td>
                <td>
                    <select id="add_event_repeat_every_weekly" name="add_event_repeat_every_weekly"
                            class="select2InputSmall" style="width: 50px">
                        <?php for ($i = 1; $i <= 30; $i++): ?>
            ...
            <tr>
                <td>Repeat on</td>
                <td>
                    <input <?php if ($eventRepeatData['on_day_0']) echo 'checked="checked"' ?> type="checkbox" value="1"
                                                                                               id="week_on_0"
                                                                                               name="week_on_0"/> S
                    <input <?php if ($eventRepeatData['on_day_1']) echo 'checked="checked"' ?> type="checkbox" value="1"
                                                                                               id="week_on_1"
                                                                                               name="week_on_1"/> M
                    <input <?php if ($eventRepeatData['on_day_2']) echo 'checked="checked"' ?> type="checkbox" value="1"
                                                                                               id="week_on_2"
                                                                                               name="week_on_2"/> T
                    <input <?php if ($eventRepeatData['on_day_3']) echo 'checked="checked"' ?> type="checkbox" value="1"
                                                                                               id="week_on_3"
                                                                                               name="week_on_3"/> W
                    <input <?php if ($eventRepeatData['on_day_4']) echo 'checked="checked"' ?> type="checkbox" value="1"
                                                                                               id="week_on_4"
                                                                                               name="week_on_4"/> T
                    <input <?php if ($eventRepeatData['on_day_5']) echo 'checked="checked"' ?> type="checkbox" value="1"
                                                                                               id="week_on_5"
                                                                                               name="week_on_5"/> F
                    <input <?php if ($eventRepeatData['on_day_6']) echo 'checked="checked"' ?> type="checkbox" value="1"
                                                                                               id="week_on_6"
                                                                                               name="week_on_6"/> S
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="radio"
                           name="repeat_data_weekly"
                        <?php if ($repeatWeekly && $defaultEventEndAfterOccurrences) {
                            echo 'checked="checked"';
                        } ?>
