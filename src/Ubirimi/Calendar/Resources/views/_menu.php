...
<table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#6A8EB2"
    ...
    <tr>
        <td>
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="center" class="menuItemBasic <?php if ($menuSelectedCategory == 'calendars') {
                        echo 'menuItemSelected';
                    } else echo 'menuItem' ?>" id="menuCalendars">
                        <span>Calendars</span>
                        <span class="<?php if ($menuSelectedCategory == 'calendars') {
                            echo 'arrowSelected';
        ...
        <td align="right" style="vertical-align: middle">
            ...
            <input id="calendar_quick_search" type="text" style="height: 15px; font-style: italic;" value="Quick Search"
                   name="search"/>
        </td>
    </tr>
</table>
