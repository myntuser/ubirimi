...
<div class="pageContent">
    <?php if (Util::userHasDocumentadorAdministrativePermission()): ?>
        ...
        <form name="edit_global_settings" action="/documentador/administration/edit-global-permissions" method="post">
            ...
            <div>For example: Enabling anonymous 'USE' permission, allows non-logged-in users to browse pages and spaces
                in Documentador.
            </div>
                ...
                <tr>
                    ...
                    <td align="center">
                        <input type="checkbox" value="1"
                               name="anonymous_use_flag" <?php if ($documentatorSettings['anonymous_use_flag']) {
                            echo 'checked="checked"';
                        } ?> />
                    </td>
                    <td align="center">
                        <input type="checkbox" value="1"
                               name="anonymous_view_user_profile_flag" <?php if ($documentatorSettings['anonymous_view_user_profile_flag']) {
                            echo 'checked="checked"';
                        } ?> />
                    </td>
                </tr>
                        ...
                        <tr>
                            ...
                            <?php while ($globalsPermission = $globalsPermissions->fetch_array(MYSQLI_ASSOC)): ?>
                                <td align="center">
                                    ...
                                    )->getDataByPermissionIdAndGroupId(
                                        $clientId,
                ...
                <tr>
                    <td align="left">
                        <button type="submit" name="update_configuration" class="btn ubirimi-btn"><i
                                class="icon-edit"></i> Update Permissions
                        </button>
