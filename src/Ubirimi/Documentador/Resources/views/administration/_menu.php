    ...
    <tr>
        <td>
            <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td class="menuItemBasic <?php if ($menuSelectedCategory == 'doc_administration') {
                        echo 'menuItemSelected';
                    } else echo 'menuItem' ?>" id="menuAdminDocHome">
                        <span><a style="<?php if ($menuSelectedCategory == 'doc_administration') {
                                echo 'color: black';
                            } else echo 'color: white;' ?>" href="/documentador/administration" class="linkNoUnderline">Administration</a></span>
                        &nbsp;
                    </td>
                    <td width="8px"></td>
                    <?php if ($session->get('user/super_user_flag')): ?>

                        <td class="menuItemBasic <?php if ($menuSelectedCategory == 'doc_configuration') {
                            echo 'menuItemSelected';
                        } else echo 'menuItem' ?>" id="menuAdminDocConfiguration">
                            <span>Configuration</span>
                            <span class="<?php if ($menuSelectedCategory == 'doc_configuration') {
                                echo 'arrowSelected';
                        ...
                        <td width="8px"></td>
                    <?php endif ?>
                    <td class="menuItemBasic <?php if ($menuSelectedCategory == 'doc_spaces') {
                        echo 'menuItemSelected';
                    } else echo 'menuItem' ?>" id="menuAdminDocSpaces">
                        <span>Spaces</span>
                        <span class="<?php if ($menuSelectedCategory == 'doc_spaces') {
                            echo 'arrowSelected';
                        } else echo 'arrow' ?>" id="arrowProjects"></span>
                        &nbsp;
                    </td>
                    <?php if ($hasDocumentadorGlobalAdministrationPermission || $hasDocumentadorGlobalSystemAdministrationPermission): ?>
                        <td width="8px"></td>
                        <td class="menuItemBasic <?php if ($menuSelectedCategory == 'doc_users') {
                            echo 'menuItemSelected';
                        } else echo 'menuItem' ?>" id="menuAdminDocUsersSecurity">
                            <span>Users & Security</span>
                            <span class="<?php if ($menuSelectedCategory == 'doc_users') {
                                echo 'arrowSelected';
                            } else echo 'arrow' ?>" id="arrowProjects"></span>
                            &nbsp;
                        </td>
                    ...
                    <?php endif ?>
                    <?php if ($session->get('user/super_user_flag')): ?>
                        <td class="menuItemBasic <?php if ($menuSelectedCategory == 'doc_look_feel') {
                            echo 'menuItemSelected';
                        } else echo 'menuItem' ?>" id="menuAdminDocLookFeel">
                            <span>Look & Feel</span>
                            <span class="<?php if ($menuSelectedCategory == 'doc_look_feel') {
                                echo 'arrowSelected';
                            } else echo 'arrow' ?>" id="arrowProjects"></span>
                            &nbsp;
                        </td>
                        <td width="8px"></td>
                        <td class="menuItemBasic <?php if ($menuSelectedCategory == 'doc_system') {
                            echo 'menuItemSelected';
                        } else echo 'menuItem' ?>" id="menuAdminDocSystem">
                            <span>System</span>
                            <span class="<?php if ($menuSelectedCategory == 'doc_system') {
                                echo 'arrowSelected';
                            } else echo 'arrow' ?>" id="arrowProjects"></span>
                            &nbsp;
                        </td>
        ...
        <td align="right">
            <input type="text" size="28" style="height: 15px; font-style: italic;" value="Administration Quick Search"
                   name="search"/>
        </td>
    </tr>
</table>
...
<div id="contentMenuAdminDocUsersSecurity" style="display: none;">
    <table cellspacing="0" cellpadding="0" border="0" class="tableMenu" width="100%">
        <tr>
            <td>
                <div><a class="linkSubMenu" href="/documentador/administration/users">Users</a></div>
            </td>
        </tr>
        <tr>
            <td>
                <div><a class="linkSubMenu" href="/documentador/administration/groups">Groups</a></div>
            </td>
        </tr>
        <?php if ($hasDocumentadorGlobalSystemAdministrationPermission): ?>
            ...
            <tr>
                <td>
                    <div><a class="linkSubMenu" href="/documentador/administration/global-permissions">Global
                            Permissions</a></div>
                </td>
            </tr>
        <?php endif ?>
...
<div id="contentMenuAdminDocSystem" style="display: none;">
    <table cellspacing="0" cellpadding="0" border="0" class="tableMenu" width="100%">
        <tr>
            <td>
                <div><a class="linkSubMenu" href="/yongo/administration/general-configuration">System Information</a>
                </div>
            </td>
        </tr>
    </table>
