...
<div class="pageContent">
    ...
    <ul class="nav nav-tabs" style="padding: 0px;">
        ...
        <li class="active"><a href="/documentador/administration/space-tools/content/trash/<?php echo $spaceId ?>">Content
                Tools</a></li>
    </ul>

    <br/>

    <div class="infoBox">The trash stores all deleted pages. You can restore or purge deleted pages from this screen.
    </div>

    <ul class="nav nav-tabs" style="padding: 0px;">
        <li class="active"><a href="/documentador/administration/space-tools/overview/<?php echo $spaceId ?>">Trash</a>
        </li>
    </ul>
