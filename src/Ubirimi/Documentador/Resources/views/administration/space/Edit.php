...
<div class="pageContent">
    <form name="edit_workflow"
          action="/documentador/administration/space/edit/<?php echo $spaceId ?><?php if (isset($backLink)) echo '?back=' . $backLink ?>"
          method="post">
        <table width="100%">
            <tr>
                ...
                <td>
                    <select name="homepage" class="select2Input">
                        <?php while ($pages && $page = $pages->fetch_array(MYSQLI_ASSOC)): ?>
                            <option <?php if ($space['home_entity_id'] == $page['id']) echo 'selected="selected"' ?>
            ...
            <tr>
                ...
                <td>
                    <textarea class="inputTextAreaLarge"
                              name="description"><?php echo $space['description'] ?></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td align="let">
                    <div align="left">
                        <button type="submit" name="edit_space" class="btn ubirimi-btn"><i class="icon-edit"></i> Update
                            Space
                        </button>
                        <?php if (isset($backLink) && $backLink == 'space_tools'): ?>
                            <a class="btn ubirimi-btn"
                               href="/documentador/administration/space-tools/overview/<?php echo $spaceId ?>">Cancel</a>
                        <?php else: ?>
