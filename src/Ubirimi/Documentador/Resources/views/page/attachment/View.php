...
<div class="pageContent">
        ...
        <table class="table table-hover table-condensed">
            ...
            <?php while ($file = $attachments->fetch_array(MYSQLI_ASSOC)): ?>
                <tr>
                    ...
                    <td>
                        <a class="btn ubirimi-btn" href="#"
                           id="delete_doc_attachment_<?php echo $file['id'] ?>">Delete</a>
                    </td>
                </tr>
    ...
    <?php if ($loggedInUserId): ?>
        ...
        <form name="page_upload_file" method="post" enctype="multipart/form-data"
              action="/documentador/entity/upload-attachment/<?php echo $entityId ?>">
            <div style="border: dashed blue 1px; padding: 8px">
                ...
                <input style="padding: 4px" name="entity_upload_attachment[]" type="file" multiple=""
    ...
    <input type="hidden" value="<?php echo $entityId ?>" id="entity_id"/> <input type="hidden"
                                                                                 value="<?php echo $spaceId ?>"
                                                                                 id="space_id"/>
