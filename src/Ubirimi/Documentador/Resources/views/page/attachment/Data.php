...
while ($revision = $revisions->fetch_array(MYSQLI_ASSOC)) {
    ...
    echo '<tr>';
    echo '<td style="border: none;"><a href="/assets' . UbirimiContainer::get(
        )['asset.documentador_entity_attachments'] . $spaceId . '/' . $entity['id'] . '/' . $attachmentId . '/' . $revisionNumber . '/' . $attachment['name'] . '">Version ' . ($revisions->num_rows - $index) . '</a></td>';
    ...
    echo '</td>';
    echo '<td style="border: none;">' . Util::getFormattedDate(
