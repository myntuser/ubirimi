...
<div class="headerPageBackground">
    <table width="100%">
        <tr>
            <td>
                <div class="headerPageText"><a href="/documentador/spaces" class="linkNoUnderline">Spaces</a>
                    > <?php echo $page['space_name'] ?> >
                    <a class="linkNoUnderline" href="/documentador/pages/<?php echo $spaceId ?>">Pages</a>
                    > <?php echo $page['name'] ?> > History
                </div>
            </td>
        </tr>
    </table>
...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            ...
            <td><a id="btnRemoveRevision" href="#" class="btn ubirimi-btn disabled"><i class="icon-remove"></i>
                    Remove</a></td>
        </tr>
    </table>
                        ...
                        <tr id="table_row_<?php echo $revision['id'] ?>">
                            <td width="22">
                                <input disabled="disabled" type="checkbox" value="1"
                                       id="el_check_<?php echo $revision['id'] ?>"/>
                            </td>
                            <td>
                                <div>
                                    <span><b><a href="/documentador/page/view/<?php echo $entityId ?>">CURRENT
                                                (v. <?php echo $revisionCount-- ?>)</a></b></span>
                                </div>
                            </td>
                            <td>
                        ...
                        <?php while ($revision = $revisions->fetch_array(MYSQLI_ASSOC)): ?>
                            <tr id="table_row_<?php echo $revision['id'] ?>">
                                <td width="22"><input type="checkbox" value="1"
                                                      id="el_check_<?php echo $revision['id'] ?>"/></td>
                                <td>
                                    <div>
                                        <span><a
                                                href="/documentador/page/view/<?php echo $entityId ?>/<?php echo $revision['id'] ?>"><b>v. <?php echo $revisionCount-- ?>
                                            </a></b></span>
                                        <input type="hidden" value="<?php echo($revisionCount + 1) ?>"
                                               id="revision_<?php echo $revision['id'] ?>"/>
                                    </div>
                                </td>
                                <td>
