        ...
        <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
            <tr>
                <?php if (UbirimiContainer::get()['repository']->get(UbirimiUser::class)->hasGlobalPermission(
                    ...
                    <td><a id="btnNew" href="/documentador/administration/spaces/add" class="btn ubirimi-btn"><i
                                class="icon-plus"></i> Create New Space</a></td>
                <?php endif ?>
            </tr>
        </table>
    <?php endif ?>
                    ...
                    <?php if (Util::checkUserIsLoggedIn()): ?>
                        <td width="150px" align="center">
                            ...
                            $isFavourite = UbirimiContainer::get()['repository']->get(
                                Space::class
                            )->checkSpaceIsFavouriteForUserId($space['space_id'], $loggedInUserId);
                            if ($isFavourite) {
