    ...
    <?php if ($type == 'spaces'): ?>
        <?php if (Util::checkUserIsLoggedIn()): ?>
            <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
                <tr>
                    <td><a href="/documentador/administration/spaces/add" class="btn ubirimi-btn"><i
                                class="icon-plus"></i> Create Space</a></td>
                </tr>
            </table>
        <?php endif ?>
        <?php if ($spaces): ?>
        ...
        <?php if ($pages): ?>
            <table class="table table-hover table-condensed">
                ...
                <?php while ($page = $pages->fetch_array(MYSQLI_ASSOC)): ?>
                    <tr>
                        <td><a href="/documentador/page/view/<?php echo $page['id'] ?>"><?php echo $page['name'] ?></a>
                        </td>
                    </tr>
                <?php endwhile ?>
                </tbody>
