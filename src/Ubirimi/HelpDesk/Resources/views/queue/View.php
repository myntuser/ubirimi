...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td>
                <a href="/helpdesk/queue/add/<?php echo $projectId ?>" class="btn ubirimi-btn"><i class="icon-plus"></i>
                    Create Queue</a>
                <?php if ($queues): ?>
                    <a href="/helpdesk/queue/edit/<?php echo $queueSelected['id'] ?>" class="btn ubirimi-btn"><i
