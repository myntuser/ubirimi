...
<?php Util::renderBreadCrumb(
    '<a class="linkNoUnderline" href="/helpdesk/queues/' . $projectId . '/' . $selectedQueueId . '">Queues</a> > Create Queue'
) ?>
    ...
    <form name="add_queue" action="/helpdesk/queue/add/<?php echo $projectId ?>" method="post">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="new_queue" class="btn ubirimi-btn"><i class="icon-plus"></i> Create
                            Queue
                        </button>
                        <a class="btn ubirimi-btn"
                           href="/helpdesk/queues/<?php echo $projectId ?>/<?php echo $selectedQueueId ?>">Cancel</a>
                    </div>
                </td>
            </tr>
        </table>
