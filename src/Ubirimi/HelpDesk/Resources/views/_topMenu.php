<ul class="nav nav-tabs" style="padding: 0px;">
    <li <?php if ($menuProjectCategory == 'queue'): ?>class="active"<?php endif ?>>
        <a href="/helpdesk/queues/<?php echo $projectId ?>/<?php if (isset($queueSelected)) {
    ...
    <li <?php if ($menuProjectCategory == 'reports'): ?>class="active"<?php endif ?>>
        <a href="/helpdesk/report/<?php echo $projectId ?>/<?php if (isset($slaSelected)) {
            echo $slaSelected['id'];
        } else {
            echo '-1';
    ...
    <li <?php if ($menuProjectCategory == 'customer_portal'): ?>class="active" <?php endif ?>>
        <a href="/helpdesk/customer-portal/administration/home/<?php echo $projectId ?>" title="Customer Portal">Customer
            Portal</a>
    </li>
</ul>