                ...
                <div class="clearfix">
                    <div class="align-left">
                        <form name="f_login" method="post" class="standard-form"
                              action="/helpdesk/customer-portal/sign-up">
                            <div class="form-section clearfix sectionFeature blue">
                                ...
                                <fieldset>
                                    <label for="sign-in-password">repeat password <span
                                    ...
                                    <?php elseif ($errors['email_not_valid']): ?>
                                        <div class="HPFieldLabel14Red">The email address is not valid.</div>
                                    <?php elseif ($errors['email_already_exists']): ?>
                                        <div class="HPFieldLabel14Red">The email address is already assigned to another
                                            user.
                                        </div>
                                    <?php endif ?>
                            ...
                            <button type="submit" class="button_hp blue" name="create_account">Create Customer Account
                            </button>
