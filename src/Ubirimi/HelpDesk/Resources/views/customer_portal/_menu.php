        ...
        <td style="height: 40px" valign="middle">
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="height: 44px">
                <tr>
                    <?php ($session->get(
                            'selected_product_id'
                        ) == -2) ? $style = 'background-color: #6A8EB2;' : $style = '' ?>
                    ...
                    <?php ($session->get(
                            'selected_product_id'
                        ) == SystemProduct::SYS_PRODUCT_HELP_DESK) ? $style = 'background-color: #6A8EB2;' : $style = '' ?>

                    <td style="border-right: 1px #9c9c9c solid; <?php echo $style ?>" width="100px" class="product-menu"
    ...
    <tr>
                ...
                <tr>
                    <?php if ($menuSelectedCategory == 'ubirimi_about'): ?>
                        <td class="menuItemBasic menuItemSelected">
                            <span><a class="linkNoUnderline" style="color: black"
                                     href="/helpdesk/customer-portal/about">About</a></span>
                        </td>
                    <?php else: ?>
                        <td class="menuItemBasic <?php if ($menuSelectedCategory == 'home') {
                            echo 'menuItemSelected';
                        } else echo 'menuItem' ?>">
                            <span><a class="linkNoUnderline" style="<?php if ($menuSelectedCategory == 'home') {
                                    echo 'color: black';
                                } else echo 'color: white;' ?>" href="/helpdesk/customer-portal/dashboard">Dashboard</a></span>
                        </td>
                        <td width="8px"></td>
        ...
        <?php if ($session->has('selected_project_id')): ?>
            <td align="right" style="vertical-align: middle">
                ...
                <input id="ubirimi_quick_search" type="text"
                       style="height: 15px; margin-right: 12px; font-style: italic;" value="Quick Search"
                       name="search"/>
            </td>
        <?php endif ?>
    </tr>
...
<div style="display: none;" id="contentUserHome">
    <table class="tableMenu" width="100%" cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>
            <td>
                <div><a class="linkSubMenu" href="/helpdesk/customer-portal/sign-out">Sign out</a></div>
            </td>
        </tr>
    </table>
</div>
