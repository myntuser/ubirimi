...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a id="btnNew" href="/yongo/administration/project/add?helpdesk=true" class="btn ubirimi-btn"><i
                        class="icon-plus"></i> Create New HelpDesk</a></td>
        </tr>
    </table>
        ...
        <table class="table table-hover table-condensed">
            ...
            <?php while ($project = $projects->fetch_array(MYSQLI_ASSOC)): ?>
                <tr>
                    ...
                    <td>
                        <?php
                        $queues = UbirimiContainer::get()['repository']->get(Queue::class)->getByProjectId(
                            $project['id']
                        );
                        $queueSelectedId = -1;
                        if ($queues) {
