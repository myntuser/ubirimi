...
<div class="pageContent">
    <?php if (Util::userHasClientAdministrationPermission()): ?>
        <form id="form_add_customer" name="add_customer"
              action="/helpdesk/administration/customers/add<?php if ($organizationId) echo '?id=' . $organizationId ?>"
              method="post">
            <table width="100%">
                <tr>
                ...
                <tr>
                    ...
                    <td style="vertical-align: middle">
                        <button type="submit" class="btn ubirimi-btn" name="confirm_new_customer">Create Customer
                        </button>
                        <a class="btn ubirimi-btn"
                           href="/helpdesk/administration/customers?id=<?php echo $organizationId ?>">Cancel</a>
                    </td>
                </tr>
            </table>
        </form>
