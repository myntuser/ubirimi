...
<?php Util::renderBreadCrumb(
    '<a class="linkNoUnderline" href="/helpdesk/administration/organizations">Organizations</a> > Update Organization'
) ?>
<div class="pageContent">
    <form name="add_status" action="/helpdesk/administration/organizations/edit/<?php echo $organizationId ?>"
          method="post">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea name="description"
                              class="inputTextAreaLarge"><?php echo $organization['description']; ?></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="edit_organization" class="btn ubirimi-btn"><i class="icon-plus"></i>
                            Update Organization
                        </button>
