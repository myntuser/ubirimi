...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td><a id="btnNew" href="/helpdesk/administration/organizations/add" class="btn ubirimi-btn"><i
                        class="icon-plus"></i> Create Organization</a></td>
            <?php if ($organizations): ?>
                <td><a id="btnEditOrganization" href="#" class="btn ubirimi-btn disabled"><i class="icon-edit"></i> Edit</a>
                </td>
                <td><a id="btnDeleteOrganization" href="#" class="btn ubirimi-btn disabled"><i class="icon-remove"></i>
                        Delete</a></td>
            <?php endif ?>
        </tr>
    </table>
        ...
        <table class="table table-hover table-condensed">
            ...
            <?php while ($organization = $organizations->fetch_array(MYSQLI_ASSOC)): ?>
                <tr id="table_row_<?php echo $organization['id'] ?>">
                    ...
                    <td><a href="/helpdesk/administration/customers?id=<?php echo $organization['id'] ?>">View All</a>
                    </td>
                </tr>
            <?php endwhile ?>
            </tbody>
