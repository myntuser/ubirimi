    ...
    <tr>
        <td>
            <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td class="menuItemBasic <?php if ($menuSelectedCategory == 'helpdesk_administration') {
                        echo 'menuItemSelected';
                    } else echo 'menuItem' ?>" id="menuAdminHelpdeskHome">
                        <span><a style="<?php if ($menuSelectedCategory == 'helpdesk_administration') {
                                echo 'color: black';
                            } else echo 'color: white;' ?>" href="/helpdesk/administration" class="linkNoUnderline">Administration</a></span>
                        &nbsp;
                    </td>
                    <td width="8px"></td>
                    <td class="menuItemBasic <?php if ($menuSelectedCategory == 'helpdesk_organizations') {
                        echo 'menuItemSelected';
                    } else echo 'menuItem' ?>" id="menuAdminHelpdeskOrganizations">
                        <span>Organizations</span>
                        <span class="<?php if ($menuSelectedCategory == 'helpdesk_organizations') {
                            echo 'arrowSelected';
