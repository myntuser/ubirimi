...
<div class="pageContent">
    ...
    <table cellspacing="0" border="0" cellpadding="0" class="tableButtons">
        <tr>
            <td>
                <a href="/helpdesk/sla/add/<?php echo $projectId ?>" class="btn ubirimi-btn"><i class="icon-plus"></i>
                    Create SLA</a>
                <a href="/helpdesk/sla/edit/<?php echo $slaSelectedId ?>" class="btn ubirimi-btn"><i
                        ...
                        <tr>
                            <td align="left" valign="top">
                                <?php for ($i = 0; $i < count($startConditions); $i++): ?>
                                    <div class="slaCondition"><?php echo UbirimiContainer::get()['repository']->get(
                                            Sla::class
                                        )->transformConditionForView($startConditions[$i]) ?></div>
                                <?php endfor ?>
                            </td>
                            <td></td>
                            <td align="left" valign="top">
                                <?php for ($i = 0; $i < count($stopConditions); $i++): ?>
                                    <div class="slaCondition"><?php echo UbirimiContainer::get()['repository']->get(
                                            Sla::class
                                        )->transformConditionForView($stopConditions[$i]) ?></div>
                                <?php endfor ?>
                            </td>
                        </tr>
                    </table>
