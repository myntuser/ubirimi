        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    ...
                    <div>Issues will be checked against this list, top to bottom, and assigned a time target based on
                        the first matching YQL statement.
                    </div>
                    ...
                    <table class="table table-hover table-condensed" id="slaGoals">
                            ...
                            <tr>
                                <td>
                                    <?php if ($goal['definition'] == 'all_remaining_issues'): ?>
                                        ...
                                        <input type="hidden" value="all_remaining_issues"
                                               name="goal_definition_<?php echo $goal['id'] ?>"/>
                                    <?php else: ?>
                                ...
                                <td style="vertical-align: top">
                                    ...
                                    <select name="goal_calendar_<?php echo $goal['id'] ?>" class="select2InputSmall">
                                        <?php while ($calendar = $slaCalendars->fetch_array(MYSQLI_ASSOC)): ?>
                                            <option <?php if ($goal['help_sla_calendar_id'] == $calendar['id']) echo 'selected="selected"' ?>
                                                value="<?php echo $calendar['id'] ?>"><?php echo $calendar['name'] ?></option>
                                        <?php endwhile ?>
                                    </select>
                                </td>
                                <td style="vertical-align: top">
                                    <button type="button" id="delete_goal_<?php echo $goal['id'] ?>"
                        ...
                        <?php if (!$allRemainingIssuesDefinitionFound): ?>
                            <tr>
                                ...
                                <td style="vertical-align: top">
                                    <?php $slaCalendars->data_seek(0) ?>
                                    <select name="goal_calendar_0<?php echo $goal['value'] ?>"
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="confirm_update_sla" class="btn ubirimi-btn"><i
                                class="icon-plus"></i> Update SLA
                        </button>
                        <a class="btn ubirimi-btn"
                           href="<?php echo "/helpdesk/sla/" . $SLA['project_id'] . "/" . $SLA['id'] ?>">Cancel</a>
                    </div>
                </td>
            </tr>
        </table>
