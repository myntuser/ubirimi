    ...
    <form name="add_sla_calendar" action="/helpdesk/sla/calendar/edit/<?php echo $calendarId ?>" method="post">
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea class="inputTextAreaLarge"
                              name="description"><?php echo $calendar['description'] ?></textarea>
                </td>
            </tr>
                    ...
                    <td>
                        <select class="inputTextCombo" style="width: 50px" name="from_<?php echo $k ?>_hour">
                            <?php for ($i = 0; $i <= 23; $i++): ?>
                                ...
                                ?>
                                <option <?php if (substr(
                                        $calendarData['time_from'],
                                        0,
                                        2
                                    ) == $value
                        ...
                        <input <?php if ($calendarData['not_working_flag'] == 1) echo 'checked="checked"' ?>
                            type="checkbox" value="1" name="not_working_day_<?php echo $k ?>"/> Not Working
                    </td>
                </tr>
            <?php endfor ?>
            <tr>
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="confirm_edit_calendar" class="btn ubirimi-btn">Update Calendar
                        </button>
