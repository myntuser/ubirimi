<table cellspacing="0" cellpadding="2" border="0">
    <tr>
        <td width="20px" align="left" style="vertical-align: middle">
            <input type="checkbox" <?php if (isset($slaConditions) && in_array(
                    $prefixElementName . '_issue_created',
                    $slaConditions
                )
    ...
    <tr>
        <td width="20px" style="vertical-align: middle">
            <input type="checkbox" <?php if (isset($slaConditions) && in_array(
                    $prefixElementName . '_assignee_changed',
                    $slaConditions
                )
            ) echo 'checked="checked"' ?>
                   value="1"
    ...
    <tr>
        <td width="20px" style="vertical-align: middle">
            <input type="checkbox" <?php if (isset($slaConditions) && in_array(
                    $prefixElementName . '_resolution_set',
                    $slaConditions
                )
            ) echo 'checked="checked"' ?>
                   value="1"
    ...
    <?php while ($availableStatuses && $availableStatus = $availableStatuses->fetch_array(MYSQLI_ASSOC)): ?>
        <tr>
            <td width="20px" style="vertical-align: middle">
                <input type="checkbox"
                       value="1"
                    <?php if (isset($slaConditions) && in_array(
                            $prefixElementName . '_status_set_' . $availableStatus['id'],
                            $slaConditions
                        )
                    ) echo 'checked="checked"' ?>
    ...
    <tr>
        <td width="20px" style="vertical-align: middle">
            <input type="checkbox" <?php if (isset($slaConditions) && in_array(
                    $prefixElementName . '_comment_by_assignee',
                    $slaConditions
                )
            ) echo 'checked="checked"' ?>
                   value="1"
