    ...
    <form name="add_sla" action="/helpdesk/sla/add/<?php echo $projectId ?>" method="post">
        <table width="100%">
            <tr>
                ...
                <td>
                    <input id="name" class="inputText" type="text" value="<?php if (isset($name)) echo $name ?>"
                           name="name"/>
                    <?php if ($emptyName): ?>
                        <br/>
            ...
            <tr>
                ...
                <td align="left">
                    <div align="left">
                        <button type="submit" name="confirm_new_sla" class="btn ubirimi-btn"><i class="icon-plus"></i>
                            Create SLA
                        </button>
                        <a class="btn ubirimi-btn" href="<?php if (isset($slaSelected)) {
                            echo "/helpdesk/sla/" . $projectId . "/" . $slaSelected['id'];
                        } else {
                            echo '/helpdesk/sla/' . $projectId . '/-1';
                        } ?>">Cancel</a>
                    </div>
                </td>
            </tr>
