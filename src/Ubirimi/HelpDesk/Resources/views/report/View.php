...
<?php Util::renderBreadCrumb(
    sprintf('<a href="/helpdesk/all">Help Desks</a> > %s > Reports > %s', $project['name'], $slaSelected['name'])
); ?>
            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <div>
                        ...
                        <input type="text" class="inputText" style="width: 80px" value="<?php echo $dateFrom ?>"
                               id="sla_report_start_date"/>
                        <span>End Date</span>
                        <input type="text" class="inputText" style="width: 80px" value="<?php echo $dateTo ?>"
                               id="sla_report_end_date"/>
                    </div>
                    <br/>
